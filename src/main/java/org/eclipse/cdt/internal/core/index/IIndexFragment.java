...
public interface IIndexFragment
{
     ...
     * @throws CoreException
     */
    IIndexFragmentFile[] getFiles(int linkageID, IIndexFileLocation location)
            throws CoreException;
     ...
     * @throws CoreException
     */
    IIndexFragmentFile[] getFiles(IIndexFileLocation location)
            throws CoreException;
     ...
     * @throws CoreException
     */
    IIndexFragmentInclude[] findIncludedBy(IIndexFragmentFile file)
            throws CoreException;
     ...
     * @throws CoreException
     */
    IIndexFragmentBinding adaptBinding(IBinding binding)
            throws CoreException;
     ...
     * @throws CoreException
     */
    IIndexFragmentBinding findBinding(IASTName astName)
            throws CoreException;
     ...
     * @throws CoreException
     */
    IIndexFragmentBinding[] findBindings(Pattern[] patterns, boolean isFullyQualified, IndexFilter filter, IProgressMonitor monitor)
            throws CoreException;
     ...
     * @throws CoreException
     */
    IIndexFragmentName[] findNames(IBinding binding, int flags)
            throws CoreException;
     ...
     * @param monitor to report progress, may be <code>null</code>
     */
    IIndexFragmentBinding[] findBindingsForPrefix(char[] prefix, boolean filescope, IndexFilter filter, IProgressMonitor monitor)
            throws CoreException;
     ...
     * @param monitor to report progress, may be <code>null</code>
     */
    IIndexFragmentBinding[] findBindingsForContentAssist(char[] prefix, boolean filescope, IndexFilter filter, IProgressMonitor monitor)
            throws CoreException;
     ...
     * @param monitor to report progress, may be <code>null</code>
     */
    IIndexMacro[] findMacros(char[] name, boolean isPrefix, boolean caseSensitive, IndexFilter filter, IProgressMonitor monitor)
            throws CoreException;
     ...
     */
    IIndexFragmentFile[] getDefectiveFiles()
            throws CoreException;

    /**
     * @return an array of files containing unresolved includes.
     */
    IIndexFragmentFile[] getFilesWithUnresolvedIncludes()
            throws CoreException;
     ...
     * @throws CoreException
     */
    IIndexScope[] getInlineNamespaces()
            throws CoreException;
