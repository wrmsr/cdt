 ...
 */
class PDOMCPPConstructorSpecialization
        extends PDOMCPPMethodSpecialization
        implements ICPPConstructor
{
    ...
    public PDOMCPPConstructorSpecialization(PDOMCPPLinkage linkage, PDOMNode parent, ICPPConstructor constructor, PDOMBinding specialized)
