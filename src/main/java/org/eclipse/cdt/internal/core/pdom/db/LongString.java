        ...
        implements IString
{
    ...
    public LongString(Database db, final char[] chars, boolean useBytes)
    ...
    @Override
    public int compare(String other, boolean caseSensitive)
            throws CoreException
    {
    ...
    @Override
    public int compare(char[] other, boolean caseSensitive)
            throws CoreException
    {
    ...
    @Override
    public int comparePrefix(char[] other, boolean caseSensitive)
            throws CoreException
    {
    ...
    @Override
    public int compareCompatibleWithIgnoreCase(char[] other)
            throws CoreException
    {
