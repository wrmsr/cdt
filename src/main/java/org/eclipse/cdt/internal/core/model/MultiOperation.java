        ...
        extends CModelOperation
{
     ...
     */
    protected void error(int code, ICElement element)
     ...
     */
    protected abstract void processElement(ICElement element)
            throws CModelException;
     ...
     * can be processed.
     */
    protected abstract void verify(ICElement element)
            throws CModelException;
     ...
     */
    protected void verifyDestination(ICElement element, ICElement destination)
            throws CModelException
    {
     ...
     */
    protected void verifyRenaming(ICElement element)
            throws CModelException
    {
     ...
     */
    protected void verifySibling(ICElement element, ICElement destination)
            throws CModelException
    {
