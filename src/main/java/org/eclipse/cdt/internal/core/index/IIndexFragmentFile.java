...
public interface IIndexFragmentFile
        extends IIndexFile
{
     ...
     */
    void setSourceReadTime(long time)
            throws CoreException;

    /**
     * Sets the hash of the file content.
     */
    void setContentsHash(long hash)
            throws CoreException;
     ...
     */
    int getSizeAndEncodingHashcode()
            throws CoreException;
     ...
     */
    void setSizeAndEncodingHashcode(int hashcode)
            throws CoreException;
     ...
     * @since 5.7
     */
    void setReplacementHeader(String replacementHeader)
            throws CoreException;
     ...
     */
    void transferIncluders(IIndexFragmentFile source)
            throws CoreException;
     ...
     * The file 'source' must belong to the same fragment as this file.
     */
    void transferContext(IIndexFragmentFile source)
            throws CoreException;
}
