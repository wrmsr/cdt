...
public class PDOMTemplateParameterArray
{
     ...
     */
    public static long putArray(final Database db, IPDOMCPPTemplateParameter[] params)
     ...
     */
    public static IPDOMCPPTemplateParameter[] getArray(PDOMNode parent, long rec)
            throws CoreException
    {
    ...
    public static IPDOMCPPTemplateParameter[] createPDOMTemplateParameters(PDOMLinkage linkage,
            PDOMNode parent, ICPPTemplateParameter[] origParams)
    ...
    public static IPDOMCPPTemplateParameter createPDOMTemplateParameter(PDOMLinkage linkage,
            PDOMNode parent, ICPPTemplateParameter origParam)
            throws CoreException, DOMException
    {
