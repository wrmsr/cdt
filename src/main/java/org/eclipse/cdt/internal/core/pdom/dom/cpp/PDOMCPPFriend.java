        ...
        extends PDOMNode
{
    ...
    public PDOMCPPFriend(PDOMLinkage linkage, PDOMName friendSpec)
    ...
    public PDOMName getSpecifierName()
            throws CoreException
    {
    ...
    public void setNextFriend(PDOMCPPFriend nextFriend)
            throws CoreException
    {
    ...
    public PDOMCPPFriend getNextFriend()
            throws CoreException
    {
