...
public class Checksums
{
     ...
     * @since 4.0
     */
    public static MessageDigest getDefaultAlgorithm()
            throws NoSuchAlgorithmException
    {
     ...
     * @since 4.0
     */
    public static MessageDigest getAlgorithm(Map<?, ?> persistedMap)
            throws NoSuchAlgorithmException
    {
     ...
     */
    public static byte[] computeChecksum(MessageDigest md, File file)
            throws IOException
    {
        md.reset();
