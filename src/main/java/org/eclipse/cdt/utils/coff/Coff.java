...
public class Coff
{
    ...
    public static class FileHeader
    {
        ...
        public FileHeader(RandomAccessFile file, long offset)
                throws IOException
        {
            file.seek(offset);
        ...
        public FileHeader(byte[] hdr, boolean little)
                throws EOFException
        {
            commonSetup(hdr, little);
        }

        public void commonSetup(byte[] hdr, boolean little)
                throws EOFException
        {
    ...
    public static class OptionalHeader
    {
        ...
        public OptionalHeader(RandomAccessFile file)
                throws IOException
        {
            this(file, file.getFilePointer() + FileHeader.FILHSZ);
        }

        public OptionalHeader(RandomAccessFile file, long offset)
                throws IOException
        {
            file.seek(offset);
    ...
    public static class SectionHeader
    {
        ...
        public SectionHeader(RandomAccessFile file, long offset)
                throws IOException
        {
            sfile = file;
            file.seek(offset);
...
//*/
         ...
         * @since 5.1
         */
        public ByteBuffer mapSectionData()
                throws IOException
        {
    ...
    public static class Reloc
    {
        ...
        public Reloc(RandomAccessFile file)
                throws IOException
        {
            this(file, file.getFilePointer());
        }

        public Reloc(RandomAccessFile file, long offset)
                throws IOException
        {
            file.seek(offset);
    ...
    public static class Lineno
    {
        ...
        public Lineno(RandomAccessFile file)
                throws IOException
        {
            this(file, file.getFilePointer());
        }

        public Lineno(RandomAccessFile file, long offset)
                throws IOException
        {
            file.seek(offset);
    ...
    public static class Symbol
    {
        ...
        public Symbol(RandomAccessFile file)
                throws IOException
        {
            this(file, file.getFilePointer(), false);
        }

        public Symbol(RandomAccessFile file, long offset)
                throws IOException
        {
         ...
         * @since 5.4
         */
        public Symbol(RandomAccessFile file, boolean is64Bit)
                throws IOException
        {
         ...
         * @since 5.4
         */
        public Symbol(RandomAccessFile file, long offset, boolean is64Bit)
                throws IOException
        {
...
//		}
    ...
    public Coff(RandomAccessFile file, long offset)
            throws IOException
    {
        commonSetup(file, offset);
    }

    void commonSetup(RandomAccessFile file, long offset)
            throws IOException
    {
