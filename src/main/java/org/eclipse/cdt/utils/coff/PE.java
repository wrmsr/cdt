...
public class PE
{
    ...
    public static class DOSHeader
    {
        ...
        public DOSHeader(RandomAccessFile file)
                throws IOException
        {
            this(file, file.getFilePointer());
        }

        public DOSHeader(RandomAccessFile file, long offset)
                throws IOException
        {
            file.seek(offset);
        ...
        public DOSHeader(byte[] hdr, boolean little)
                throws IOException
        {
        ...
        public DOSHeader(ReadMemoryAccess memory)
                throws IOException
        {
            commonSetup(memory);
        }

        public void commonSetup(ReadMemoryAccess memory)
                throws IOException
        {
    ...
    public static class IMAGE_DEBUG_DIRECTORY
    {
        ...
        public IMAGE_DEBUG_DIRECTORY(RandomAccessFile file, long offset)
                throws IOException
        {
            file.seek(offset);
    ...
    public static class NTOptionalHeader
    {
        ...
        public NTOptionalHeader(RandomAccessFile file)
                throws IOException
        {
            this(file, file.getFilePointer());
        }

        public NTOptionalHeader(RandomAccessFile file, long offset)
                throws IOException
        {
            file.seek(offset);
    ...
    public class ImportDirectoryEntry
    {
        ...
        public ImportDirectoryEntry(RandomAccessFile file)
                throws IOException
        {
            this(file, file.getFilePointer());
        }

        public ImportDirectoryEntry(RandomAccessFile file, long offset)
                throws IOException
        {
            file.seek(offset);
    ...
    public PE(String filename, long pos)
            throws IOException
    {
        this(filename, pos, true);
    }

    public PE(String filename, long pos, boolean filter)
            throws IOException
    {
        try {
    ...
    public static Attribute getAttribute(byte[] data)
            throws IOException
    {
    ...
    public static Attribute getAttribute(String file)
            throws IOException
    {
        PE pe = new PE(file);
     ...
     * @since 5.1
     */
    public String getStringTableEntry(int offset)
            throws IOException
    {
        byte[] bytes = getStringTable();
        offset = offset - 4;
