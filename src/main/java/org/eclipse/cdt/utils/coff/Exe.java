...
public class Exe
{
    ...
    static public class ExeHeader
    {
        ...
        protected ExeHeader(RandomAccessFile file)
                throws IOException
        {
            this(file, file.getFilePointer());
        }

        protected ExeHeader(RandomAccessFile file, long offset)
                throws IOException
        {
            file.seek(offset);
        ...
        public ExeHeader(byte[] hdr, boolean little)
                throws IOException
        {
            ReadMemoryAccess memory = new ReadMemoryAccess(hdr, true);
            commonSetup(memory);
        ...
        void commonSetup(ReadMemoryAccess memory)
                throws IOException
        {
