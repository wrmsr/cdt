...
public class Elf
{
    ...
    public Elf(String file, long offset)
            throws IOException
    {
    ...
    public Section[] getSections(int type)
            throws IOException
    {
        if (sections == null) {
            getSections();
    ...
    /** @since 5.4 */
    public static long makeUnsignedLong(byte[] val, int offset, boolean isle)
            throws IOException
    {
