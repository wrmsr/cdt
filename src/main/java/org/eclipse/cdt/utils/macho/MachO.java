...
public class MachO
{
    ...
    protected String string_from_macho_symtab(MachO.SymtabCommand symtab, int index)
            throws IOException
    {
    ...
    public MachO(String file, long offset)
            throws IOException
    {
        commonSetup(file, offset, true);
    }

    public MachO(String file)
            throws IOException
    {
        commonSetup(file, 0, true);
    }

    public MachO(String file, long offset, boolean filton)
            throws IOException
    {
        commonSetup(file, offset, filton);
    }

    public MachO(String file, boolean filton)
            throws IOException
    {
