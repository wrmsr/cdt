...
public class MachO64
{
    ...
    private static final int makeInt(byte[] val, int offset, boolean isle)
            throws IOException
    {
    ...
    protected String string_from_macho_symtab(MachO64.SymtabCommand symtab, int index)
            throws IOException
    {
    ...
    public MachO64(String file, long offset)
            throws IOException
    {
        commonSetup(file, offset, true);
    }

    public MachO64(String file)
            throws IOException
    {
        commonSetup(file, 0, true);
    }

    public MachO64(String file, long offset, boolean filton)
            throws IOException
    {
        commonSetup(file, offset, filton);
    }

    public MachO64(String file, boolean filton)
            throws IOException
    {
    ...
    private ArrayList<Section> getSections(SegmentCommand seg)
            throws IOException
    {
        if (seg.nsects == 0) {
...
//	}
    ...
    private String getLCStr(int len)
            throws IOException
    {
        if (len == 0) {
            return EMPTY_STRING;
