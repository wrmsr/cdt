...
public class Addr2line
{
    ...
    public Addr2line(String command, String[] params, String file)
            throws IOException
    {
        init(command, params, file);
    }

    public Addr2line(String command, String file)
            throws IOException
    {
        this(command, new String[0], file);
    }

    public Addr2line(String file)
            throws IOException
    {
        this("addr2line", file); //$NON-NLS-1$
    }

    protected void init(String command, String[] params, String file)
            throws IOException
    {
    ...
    protected void getOutput(String address)
            throws IOException
    {
    ...
    public String getFunction(IAddress address)
            throws IOException
    {
        getOutput(address.toString(16));
        return lastsymbol;
     ...
     *  hello.c:39
     */
    public String getFileName(IAddress address)
            throws IOException
    {
