...
//				throw new BuildMacroException(BuildMacroException.TYPE_MACROS_UNDEFINED,fName);
        ...
        protected String stringListToString(String values[])
                throws CdtVariableException
        {
            String result = null;
            String delimiter;
...
//		private int fEnvSupplierNum;
    ...
    protected String resolveToString(MacroDescriptor des)
            throws CdtVariableException
    {
        String result = null;
    ...
    protected String[] resolveToStringList(MacroDescriptor des)
            throws CdtVariableException
    {
        String result[] = null;
        ResolvedMacro value = getResolvedMacro(des);
    ...
    protected ResolvedMacro resolveMacro(MacroDescriptor des)
            throws CdtVariableException
    {
    ...
    protected ResolvedMacro resolveParentMacro(MacroDescriptor macroDes)
            throws CdtVariableException
    {
    ...
    public void setDelimiterMap(Map<?, ?> delimiterMap)
            throws CdtVariableException
    {
    ...
    public void setInexistentMacroValue(String inexistentMacroValue)
            throws CdtVariableException
    {
