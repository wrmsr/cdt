...
public class Objdump
{
    ...
    public Objdump(String command, String param, String file)
            throws IOException
    {
        String[] params;
    ...
    public Objdump(String command, String[] params, String file)
            throws IOException
    {
        init(command, params, file);
    }

    public Objdump(String file)
            throws IOException
    {
     ...
     *  @since 5.8
     */
    public byte[] getOutput(int limitBytes)
            throws IOException
    {
