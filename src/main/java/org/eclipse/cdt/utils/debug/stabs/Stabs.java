...
public class Stabs
{
    ...
    DebugType parseStabType(String name, Reader reader)
            throws IOException
    {
        return parseStabType(name, null, reader);
    }

    DebugType parseStabType(String name, TypeInformation oldType, Reader reader)
            throws IOException
    {
     ...
     * @return
     */
    DebugType parseStabCrossRefType(String name, Reader reader)
            throws IOException
    {
     ...
     * @return
     */
    private DebugType parseStabBuiltinType(String name, char desc, Reader reader)
            throws IOException
    {
    ...
    DebugType parseStabArrayType(String name, Reader reader)
            throws IOException
    {
     ...
     * @return
     */
    DebugType parseStabEnumType(String name, Reader reader)
            throws IOException
    {
     ...
     * @return
     */
    DebugType parseStabStructType(String name, TypeNumber typeNumber, boolean union, Reader reader)
            throws IOException
    {
        int c;
        StringBuffer sb = new StringBuffer();
    ...
    void parseStabStructField(DebugStructType structType, Reader reader)
            throws IOException
    {
        // get the field name.
        StringBuffer sb = new StringBuffer();
    ...
    DebugType parseStabRangeType(String name, TypeNumber number, Reader reader)
            throws IOException
    {
    ...
    void parseStabConstant(IDebugEntryRequestor requestor, String name, Reader reader, long value)
            throws IOException
    {
        int c = reader.read();
        if (c == '=') {
