...
public class Dwarf
{
    ...
    int read_4_bytes(ByteBuffer in)
            throws IOException
    {
        try {
    ...
    long read_8_bytes(ByteBuffer in)
            throws IOException
    {
        try {
    ...
    short read_2_bytes(ByteBuffer in)
            throws IOException
    {
        try {
    ...
    /* unsigned */
    long read_unsigned_leb128(ByteBuffer in)
            throws IOException
    {
        /* unsigned */
        long result = 0;
    ...
    /* unsigned */
    long read_signed_leb128(ByteBuffer in)
            throws IOException
    {
		/* unsigned */
        long result = 0;
     ...
     * @throws IOException
     */
    InitialLengthValue readInitialLengthField(ByteBuffer data)
            throws IOException
    {
    ...
    Map<Long, AbbreviationEntry> parseDebugAbbreviation(CompilationUnitHeader header)
            throws IOException
    {
    ...
    Object readAttribute(int form, ByteBuffer in, CompilationUnitHeader header)
            throws IOException
    {
        Object obj = null;
        switch (form) {
    ...
    Long readAddress(ByteBuffer in, CompilationUnitHeader header, boolean reference)
            throws IOException
    {
        long value = 0;
