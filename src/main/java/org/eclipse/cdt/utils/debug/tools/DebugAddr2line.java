...
public class DebugAddr2line
{
    ...
    public DebugAddr2line(String file)
            throws IOException
    {
     ...
     */
    public int getEndLine(long address)
            throws IOException
    {
        DebugSym entry = symreq.getEntry(address);
        if (entry != null) {
     ...
     */
    public String getFunction(long address)
            throws IOException
    {
        DebugSym entry = symreq.getEntry(address);
        if (entry != null) {
     ...
     */
    public String getFileName(long address)
            throws IOException
    {
        DebugSym entry = symreq.getEntry(address);
        if (entry != null) {
