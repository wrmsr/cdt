...
import org.eclipse.cdt.core.cdtvariables.EclipseVariablesVariableSupplier.EclipseVarMacro;
        ...
        implements ICdtVariableManager
{
            ...
            throws CdtVariableException
    {
        ...
        IVariableSubstitutor subst = new CoreVariableSubstitutor(info, null, "")
        { //$NON-NLS-1$
            @Override
     ...
     */
    @Override
    public String[] resolveStringListValues(String[] value, String nonexistentMacrosValue, String listDelimiter, ICConfigurationDescription cfg)
            throws CdtVariableException
    {
        IVariableContextInfo info = getMacroContextInfo(getContextType(cfg), cfg);
        if (info != null) {
