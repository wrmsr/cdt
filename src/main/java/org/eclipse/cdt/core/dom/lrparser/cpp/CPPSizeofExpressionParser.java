...
public class CPPSizeofExpressionParser
        extends PrsStream
        ...
        , ISecondaryParser<IASTExpression>
{
    ...
    public CPPSizeofExpressionParser(ITokenStream stream, Map<String, String> properties)
    ...
    public CPPSizeofExpressionParser(ITokenStream stream, IScanner scanner, IBuiltinBindingsProvider builtinBindingsProvider, IIndex index, Map<String, String> properties)
    {  // constructor for creating secondary parser
        initActions(properties);
        action.initializeTranslationUnit(scanner, builtinBindingsProvider, index);
        tokenMap = new TokenMap(CPPSizeofExpressionParsersym.orderedTerminalSymbols, stream.getOrderedTerminalSymbols());
