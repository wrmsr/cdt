...
import org.eclipse.cdt.core.dom.parser.cpp.semantics.Cost.DeferredUDC;
import org.eclipse.cdt.core.dom.parser.cpp.semantics.Cost.Rank;
import org.eclipse.cdt.core.dom.parser.cpp.semantics.Cost.ReferenceBinding;

import java.util.Collections;

import static org.eclipse.cdt.core.dom.ast.IASTExpression.ValueCategory.LVALUE;
import static org.eclipse.cdt.core.dom.parser.cpp.semantics.ExpressionTypes.valueCategoryFromReturnType;
import static org.eclipse.cdt.core.dom.parser.cpp.semantics.SemanticUtil.ALLCVQ;
import static org.eclipse.cdt.core.dom.parser.cpp.semantics.SemanticUtil.COND_TDEF;
...
import static org.eclipse.cdt.core.dom.parser.cpp.semantics.SemanticUtil.addQualifiers;
import static org.eclipse.cdt.core.dom.parser.cpp.semantics.SemanticUtil.calculateInheritanceDepth;
import static org.eclipse.cdt.core.dom.parser.cpp.semantics.SemanticUtil.getCVQualifier;
import static org.eclipse.cdt.core.dom.parser.cpp.semantics.SemanticUtil.getNestedType;
import static org.eclipse.cdt.core.dom.parser.cpp.semantics.SemanticUtil.isVoidType;
...
public class Conversions
{
    ...
    public static Cost checkImplicitConversionSequence(IType target, IType exprType,
            ValueCategory valueCat, UDCMode udc, Context ctx, IASTNode point)
            throws DOMException
    {
     ...
     * 8.5-16
     */
    private static Cost nonReferenceConversion(ValueCategory valueCat, IType source, IType target, UDCMode udc, IASTNode point)
            throws DOMException
    {
     ...
     */
    static Cost listInitializationSequence(EvalInitList arg, IType target, UDCMode udc, boolean isDirect, IASTNode point)
            throws DOMException
    {
    ...
    static Cost listInitializationSequenceHelper(EvalInitList arg, IType target, UDCMode udc, boolean isDirect, IASTNode point)
            throws DOMException
    {
    ...
    static Cost listInitializationOfClass(EvalInitList arg, ICPPClassType t, boolean isDirect, boolean deferUDC, IASTNode point)
            throws DOMException
    {
        if (deferUDC) {
    ...
    static final Cost copyInitializationOfClass(ValueCategory valueCat, IType source, ICPPClassType t,
            boolean deferUDC, IASTNode point)
            throws DOMException
    {
        if (deferUDC) {
     ...
     */
    static Cost initializationByConversion(ValueCategory valueCat, IType source, ICPPClassType uqSource, IType target, boolean deferUDC, IASTNode point)
            throws DOMException
    {
        if (deferUDC) {
