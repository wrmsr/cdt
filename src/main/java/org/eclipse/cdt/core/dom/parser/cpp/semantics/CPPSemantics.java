...
import org.eclipse.cdt.core.dom.parser.IASTAmbiguousDeclarator;
import org.eclipse.cdt.core.dom.parser.IASTInternalScope;
import org.eclipse.cdt.core.dom.parser.IRecursionResolvingBinding;
...
import org.eclipse.cdt.core.dom.parser.cpp.CPPASTLiteralExpression;
...
import org.eclipse.cdt.core.dom.parser.cpp.CPPBuiltinParameter;
import org.eclipse.cdt.core.dom.parser.cpp.CPPCompositeBinding;
import org.eclipse.cdt.core.dom.parser.cpp.CPPDeferredFunction;
import org.eclipse.cdt.core.dom.parser.cpp.CPPFunctionType;
import org.eclipse.cdt.core.dom.parser.cpp.CPPImplicitFunction;
import org.eclipse.cdt.core.dom.parser.cpp.CPPNamespace;
import org.eclipse.cdt.core.dom.parser.cpp.CPPNamespaceScope;
import org.eclipse.cdt.core.dom.parser.cpp.CPPPointerType;
import org.eclipse.cdt.core.dom.parser.cpp.CPPReferenceType;
import org.eclipse.cdt.core.dom.parser.cpp.CPPScope;
...
import org.eclipse.cdt.core.dom.parser.cpp.CPPUnknownConstructor;
import org.eclipse.cdt.core.dom.parser.cpp.CPPUnknownField;
...
import org.eclipse.cdt.core.dom.parser.cpp.CPPUsingDeclaration;
import org.eclipse.cdt.core.dom.parser.cpp.CPPUsingDirective;
import org.eclipse.cdt.core.dom.parser.cpp.CPPVariable;
import org.eclipse.cdt.core.dom.parser.cpp.ClassTypeHelper;
import org.eclipse.cdt.core.dom.parser.cpp.ICPPASTInternalScope;
import org.eclipse.cdt.core.dom.parser.cpp.ICPPClassSpecializationScope;
...
import org.eclipse.cdt.core.dom.parser.cpp.ICPPInternalNamespaceScope;
import org.eclipse.cdt.core.dom.parser.cpp.ICPPUnknownBinding;
import org.eclipse.cdt.core.dom.parser.cpp.ICPPUnknownType;
import org.eclipse.cdt.core.dom.parser.cpp.OverloadableOperator;
import org.eclipse.cdt.core.dom.parser.cpp.semantics.CPPTemplates.TypeSelection;
...
import org.eclipse.cdt.core.dom.parser.cpp.semantics.Cost.Rank;
...
import static org.eclipse.cdt.core.dom.parser.cpp.semantics.SemanticUtil.ALLCVQ;
import static org.eclipse.cdt.core.dom.parser.cpp.semantics.SemanticUtil.ARRAY;
import static org.eclipse.cdt.core.dom.parser.cpp.semantics.SemanticUtil.CVTYPE;
import static org.eclipse.cdt.core.dom.parser.cpp.semantics.SemanticUtil.MPTR;
import static org.eclipse.cdt.core.dom.parser.cpp.semantics.SemanticUtil.PTR;
import static org.eclipse.cdt.core.dom.parser.cpp.semantics.SemanticUtil.REF;
import static org.eclipse.cdt.core.dom.parser.cpp.semantics.SemanticUtil.TDEF;
import static org.eclipse.cdt.core.dom.parser.cpp.semantics.SemanticUtil.calculateInheritanceDepth;
import static org.eclipse.cdt.core.dom.parser.cpp.semantics.SemanticUtil.getNestedType;
import static org.eclipse.cdt.core.dom.parser.cpp.semantics.SemanticUtil.getUltimateTypeUptoPointers;
import static org.eclipse.cdt.core.dom.parser.cpp.semantics.SemanticUtil.isConversionOperator;
...
public class CPPSemantics
{
    ...
    public static void doKoenigLookup(LookupData data)
            throws DOMException
    {
    ...
    private static class NameMatcherPredicate
            implements IUnaryPredicate<ICPPFunction>
    {
        private char[] fKey;
    ...
    static ICPPScope getLookupScope(IASTName name)
            throws DOMException
    {
        IASTNode parent = name.getParent();
        IScope scope = null;
     ...
     */
    static protected void lookup(LookupData data, IScope start)
            throws DOMException
    {
    ...
    private static void lookupInlineNamespaces(LookupData data, ICPPNamespaceScope namespace,
            Set<ICPPInternalNamespaceScope> visited)
            throws DOMException
    {
    ...
    private static boolean lookupDestructor(LookupData data)
            throws DOMException
    {
    ...
    static IBinding[] getBindingsFromScope(ICPPScope scope, LookupData data)
            throws DOMException
    {
    ...
    private static class RecursionResolvingBindingFilter
            implements IUnaryPredicate<IBinding>
    {
        @Override
    ...
    static ICPPScope getParentScope(IScope scope, IASTTranslationUnit unit)
            throws DOMException
    {
    ...
    private static void storeUsingDirective(LookupData data, ICPPNamespaceScope container,
            ICPPUsingDirective directive, Set<ICPPNamespaceScope> handled)
            throws DOMException
    {
     ...
     */
    private static void lookupInNominated(LookupData data, ICPPNamespaceScope scope)
            throws DOMException
    {
...
//        return new CPPCompositeBinding(result);
    ...
    private static IBinding resolveAmbiguities(LookupData data)
            throws DOMException
    {
    ...
    private static ICPPFunction[] selectByArgumentCount(LookupData data, ICPPFunction[] functions)
            throws DOMException
    {
     ...
     */
    private static IBinding resolveFunctionDeclaration(LookupData data, ICPPFunction[] fns)
            throws DOMException
    {
     ...
     * @throws DOMException
     */
    public static IBinding findUserDefinedLiteralOperator(IASTLiteralExpression exp)
            throws DOMException
    {
        IBinding ret = null;
        /*
            ...
            throws DOMException
    {
        ...
        outer:
        for (String nsPart : namespaceParts) {
            nsPart = nsPart.trim();
            if (nsPart.length() != 0) {
