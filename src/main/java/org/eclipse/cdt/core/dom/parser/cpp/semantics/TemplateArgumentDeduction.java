...
import static org.eclipse.cdt.core.dom.parser.cpp.semantics.SemanticUtil.getSimplifiedType;
...
public class TemplateArgumentDeduction
{
    ...
    private static boolean deduceFromFunctionArg(IType par, IType arg, ValueCategory valueCat,
            TemplateArgumentDeduction deduct, IASTNode point)
            throws DOMException
    {
    ...
    static ICPPTemplateArgument[] deduceForConversion(ICPPFunctionTemplate template,
            IType conversionType, CPPTemplateParameterMap map, IASTNode point)
            throws DOMException
    {
        final ICPPTemplateParameter[] tmplParams = template.getTemplateParameters();
    ...
    private static int deduceForPartialOrdering(IType par, IType arg, TemplateArgumentDeduction deduct, IASTNode point)
            throws DOMException
    {
     ...
     * the deduced A.
     */
    private static ICPPClassType findBaseInstance(ICPPClassType a, ICPPClassTemplate pTemplate, IASTNode point)
            throws DOMException
    {
        return findBaseInstance(a, pTemplate, CPPSemantics.MAX_INHERITANCE_DEPTH, new HashSet<Object>(), point);
    }

    private static ICPPClassType findBaseInstance(ICPPClassType a, ICPPClassTemplate pTemplate, int maxdepth, HashSet<Object> handled, IASTNode point)
            throws DOMException
    {
    ...
    private static ICPPClassTemplate getPrimaryTemplate(ICPPTemplateInstance inst)
            throws DOMException
    {
    ...
    private boolean fromType(IType p, IType a, boolean allowCVQConversion, IASTNode point)
            throws DOMException
    {
        while (p != null) {
