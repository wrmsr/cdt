 ...
 * Nathan Ridge
 *******************************************************************************/
package org.eclipse.cdt.core.dom.parser.cpp.semantics;
...
import org.eclipse.cdt.core.dom.parser.IASTInternalScope;
import org.eclipse.cdt.core.dom.parser.ITypeContainer;
import org.eclipse.cdt.core.dom.parser.ProblemBinding;
import org.eclipse.cdt.core.dom.parser.ProblemType;
import org.eclipse.cdt.core.dom.parser.Value;
import org.eclipse.cdt.core.dom.parser.cpp.CPPASTName;
import org.eclipse.cdt.core.dom.parser.cpp.CPPAliasTemplateInstance;
import org.eclipse.cdt.core.dom.parser.cpp.CPPArrayType;
import org.eclipse.cdt.core.dom.parser.cpp.CPPClassInstance;
import org.eclipse.cdt.core.dom.parser.cpp.CPPClassSpecialization;
import org.eclipse.cdt.core.dom.parser.cpp.CPPClassTemplatePartialSpecialization;
import org.eclipse.cdt.core.dom.parser.cpp.CPPClassTemplatePartialSpecializationSpecialization;
import org.eclipse.cdt.core.dom.parser.cpp.CPPClassTemplateSpecialization;
import org.eclipse.cdt.core.dom.parser.cpp.CPPConstructorInstance;
import org.eclipse.cdt.core.dom.parser.cpp.CPPConstructorSpecialization;
import org.eclipse.cdt.core.dom.parser.cpp.CPPConstructorTemplateSpecialization;
import org.eclipse.cdt.core.dom.parser.cpp.CPPDeferredClassInstance;
import org.eclipse.cdt.core.dom.parser.cpp.CPPDeferredFunction;
import org.eclipse.cdt.core.dom.parser.cpp.CPPEnumerationSpecialization;
import org.eclipse.cdt.core.dom.parser.cpp.CPPFieldSpecialization;
import org.eclipse.cdt.core.dom.parser.cpp.CPPFunctionInstance;
import org.eclipse.cdt.core.dom.parser.cpp.CPPFunctionSpecialization;
import org.eclipse.cdt.core.dom.parser.cpp.CPPFunctionTemplateSpecialization;
import org.eclipse.cdt.core.dom.parser.cpp.CPPFunctionType;
import org.eclipse.cdt.core.dom.parser.cpp.CPPMethodInstance;
import org.eclipse.cdt.core.dom.parser.cpp.CPPMethodSpecialization;
import org.eclipse.cdt.core.dom.parser.cpp.CPPMethodTemplateSpecialization;
import org.eclipse.cdt.core.dom.parser.cpp.CPPParameterPackType;
import org.eclipse.cdt.core.dom.parser.cpp.CPPParameterSpecialization;
import org.eclipse.cdt.core.dom.parser.cpp.CPPPointerToMemberType;
import org.eclipse.cdt.core.dom.parser.cpp.CPPPointerType;
import org.eclipse.cdt.core.dom.parser.cpp.CPPTemplateDefinition;
import org.eclipse.cdt.core.dom.parser.cpp.CPPTemplateNonTypeArgument;
import org.eclipse.cdt.core.dom.parser.cpp.CPPTemplateNonTypeParameter;
import org.eclipse.cdt.core.dom.parser.cpp.CPPTemplateNonTypeParameterSpecialization;
import org.eclipse.cdt.core.dom.parser.cpp.CPPTemplateParameterMap;
import org.eclipse.cdt.core.dom.parser.cpp.CPPTemplateTemplateParameter;
import org.eclipse.cdt.core.dom.parser.cpp.CPPTemplateTemplateParameterSpecialization;
import org.eclipse.cdt.core.dom.parser.cpp.CPPTemplateTypeArgument;
import org.eclipse.cdt.core.dom.parser.cpp.CPPTemplateTypeParameter;
import org.eclipse.cdt.core.dom.parser.cpp.CPPTemplateTypeParameterSpecialization;
import org.eclipse.cdt.core.dom.parser.cpp.CPPTypedefSpecialization;
import org.eclipse.cdt.core.dom.parser.cpp.CPPUnknownClassInstance;
import org.eclipse.cdt.core.dom.parser.cpp.CPPUnknownMemberClass;
import org.eclipse.cdt.core.dom.parser.cpp.CPPUnknownMethod;
import org.eclipse.cdt.core.dom.parser.cpp.CPPUsingDeclarationSpecialization;
import org.eclipse.cdt.core.dom.parser.cpp.ICPPASTInternalTemplateDeclaration;
...
import org.eclipse.cdt.core.dom.parser.cpp.ICPPInternalBinding;
import org.eclipse.cdt.core.dom.parser.cpp.ICPPInternalClassTemplate;
import org.eclipse.cdt.core.dom.parser.cpp.ICPPUnknownBinding;
import org.eclipse.cdt.core.dom.parser.cpp.ICPPUnknownMember;
import org.eclipse.cdt.core.dom.parser.cpp.ICPPUnknownMemberClass;
import org.eclipse.cdt.core.dom.parser.cpp.ICPPUnknownMemberClassInstance;
import org.eclipse.cdt.core.dom.parser.cpp.ICPPUnknownType;
import org.eclipse.cdt.core.dom.parser.cpp.semantics.Conversions.Context;
import org.eclipse.cdt.core.dom.parser.cpp.semantics.Conversions.UDCMode;
import org.eclipse.cdt.core.index.IIndexType;
...
public class CPPTemplates
{
    ...
    private static IBinding instantiateFunctionTemplate(ICPPFunctionTemplate template,
            ICPPTemplateArgument[] arguments, CPPTemplateParameterMap map, IASTNode point)
            throws DOMException
    {
    ...
    private static IBinding instantiatePartialSpecialization(
            ...
            CPPTemplateParameterMap tpMap, IASTNode point)
            throws DOMException
    {
    ...
    private static IBinding instantiatePrimaryTemplate(ICPPClassTemplate template, ICPPTemplateArgument[] arguments,
            CPPTemplateParameterMap map, boolean isDef, IASTNode point)
            throws DOMException
    {
    ...
    private static IBinding deferredInstance(ICPPClassTemplate template, ICPPTemplateArgument[] arguments)
            throws DOMException
    {
        ICPPTemplateInstance instance = getInstance(template, arguments, false);
        if (instance != null) {
    ...
    private static ICPPFunction transferFunctionTemplate(ICPPFunctionTemplate f, IASTNode point)
            throws DOMException
    {
    ...
    private static ICPPTemplateArgument uniqueArg(final ICPPTemplateParameter tpar)
            throws DOMException
    {
    ...
    private static int compareSpecialization(ICPPFunctionTemplate f1, ICPPFunctionTemplate f2, TypeSelection mode, IASTNode point)
            throws DOMException
    {
     ...
     * @throws DOMException
     */
    static private int orderSpecializations(ICPPClassTemplatePartialSpecialization spec1, ICPPClassTemplatePartialSpecialization spec2, IASTNode point)
            throws DOMException
    {
        if (spec1 == null) {
            return -1;
    ...
    private static boolean isAtLeastAsSpecializedAs(ICPPClassTemplatePartialSpecialization f1, ICPPClassTemplatePartialSpecialization f2, IASTNode point)
            throws DOMException
    {
        // 14.5.5.2
    ...
    private static ICPPTemplateArgument convertNonTypeTemplateArgument(ICPPTemplateDefinition template,
            final IType paramType, ICPPTemplateArgument arg, IASTNode point)
            throws DOMException
    {
