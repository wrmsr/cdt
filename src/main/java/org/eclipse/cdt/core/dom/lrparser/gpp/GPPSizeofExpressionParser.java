...
public class GPPSizeofExpressionParser
        extends PrsStream
        ...
        , ISecondaryParser<IASTExpression>
{
    ...
    public GPPSizeofExpressionParser(ITokenStream stream, Map<String, String> properties)
    ...
    public GPPSizeofExpressionParser(ITokenStream stream, IScanner scanner, IBuiltinBindingsProvider builtinBindingsProvider, IIndex index, Map<String, String> properties)
    {  // constructor for creating secondary parser
        initActions(properties);
        action.initializeTranslationUnit(scanner, builtinBindingsProvider, index);
        tokenMap = new TokenMap(GPPSizeofExpressionParsersym.orderedTerminalSymbols, stream.getOrderedTerminalSymbols());
