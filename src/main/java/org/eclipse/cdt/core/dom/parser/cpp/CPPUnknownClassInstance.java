...
import org.eclipse.cdt.core.pdom.dom.cpp.PDOMCPPUnknownMemberClassInstance;
        ...
        implements ICPPUnknownMemberClassInstance
{
    ...
    public static ICPPUnknownMemberClassInstance unmarshal(IIndexFragment fragment, short firstBytes, ITypeMarshalBuffer buffer)
            throws CoreException
    {
