...
import org.eclipse.cdt.core.dom.parser.BacktrackException;
import org.eclipse.cdt.core.dom.parser.DeclarationOptions;
...
import org.eclipse.cdt.core.dom.parser.cpp.NameOrTemplateIDVariants.BranchPoint;
import org.eclipse.cdt.core.dom.parser.cpp.NameOrTemplateIDVariants.Variant;
        ...
        extends AbstractGNUSourceCodeParser
{
    ...
    private ICPPASTNameSpecifier ambiguousNameSpecifier(CastExprCtx ctx)
            throws BacktrackException, EndOfFileException
    {
    ...
    private ICPPASTName qualifiedName()
            throws BacktrackException, EndOfFileException
    {
     ...
     */
    private ICPPASTDecltypeSpecifier decltypeSpecifier()
            throws EndOfFileException, BacktrackException
    {
    ...
    private int haveTemplateArguments(boolean inBinaryExpression)
            throws EndOfFileException, BacktrackException
    {
    ...
    private IASTNode templateArgument(ITemplateIdStrategy strat)
            throws EndOfFileException, BacktrackException
    {
    ...
    private IASTExpression expression(final ExprKind kind, final BinaryExprCtx ctx, IASTInitializerClause expr, ITemplateIdStrategy strat)
            throws EndOfFileException, BacktrackException
    {
    ...
    private IASTExpression throwExpression()
            throws EndOfFileException, BacktrackException
    {
     ...
     * hard:    (T), (P) T, (P) (T), (T)(I)
     */
    protected IASTExpression newExpression()
            throws BacktrackException, EndOfFileException
    {
        IToken la = LA(1);
    ...
    private IASTExpression parseTypeTrait()
            throws EndOfFileException, BacktrackException
    {
    ...
    private ICPPASTLiteralExpression stringLiteral()
            throws EndOfFileException, BacktrackException
    {
        switch (LT(1)) {
            case IToken.tSTRING:
    ...
    private IASTExpression lambdaExpression()
            throws EndOfFileException, BacktrackException
    {
    ...
    private ICPPASTCapture capture()
            throws EndOfFileException, BacktrackException
    {
        final int offset = LA().getOffset();
     ...
     */
    private IASTDeclaration aliasDeclaration(final int offset)
            throws EndOfFileException,
            BacktrackException
    {
    ...
    private ICPPASTUsingDeclaration usingDeclaration(final int offset)
            throws EndOfFileException, BacktrackException
    {
     ...
     */
    private ICPPASTStaticAssertDeclaration staticAssertDeclaration()
            throws EndOfFileException, BacktrackException
    {
    ...
    private ICPPASTTemplateParameter templateParameter()
            throws EndOfFileException, BacktrackException
    {
        final int lt1 = LT(1);
     ...
     */
    @Override
    protected IASTDeclaration declaration(DeclarationOptions option)
            throws EndOfFileException, BacktrackException
    {
        List<IASTAttributeSpecifier> attributes = attributeSpecifierSeq();
        switch (LT(1)) {
    ...
    protected List<IASTAttributeSpecifier> attributeSpecifierSeq()
            throws EndOfFileException,
            BacktrackException
    {
    ...
    @Override
    protected ICPPASTAttribute singleAttribute()
            throws EndOfFileException, BacktrackException
    {
     ...
     * 	  identifier
     */
    protected void ctorInitializer(ICPPASTFunctionDefinition fdef)
            throws EndOfFileException, BacktrackException
    {
     ...
     */
    @Override
    protected Decl declSpecifierSeq(final DeclarationOptions option)
            throws BacktrackException, EndOfFileException
    {
        return declSpecifierSeq(option, false);
    }

    private ICPPASTDeclSpecifier simpleTypeSpecifier()
            throws BacktrackException, EndOfFileException
    {
    ...
    private ICPPASTDeclSpecifier simpleTypeSpecifierSequence()
            throws BacktrackException, EndOfFileException
    {
    ...
    private ICPPASTDeclSpecifier enumDeclaration(boolean allowOpaque)
            throws BacktrackException, EndOfFileException
    {
        IToken mark = mark();
    ...
    private IASTInitializer bracedOrCtorStyleInitializer()
            throws EndOfFileException, BacktrackException
    {
        final int lt1 = LT(1);
        if (lt1 == IToken.tLPAREN) {
    ...
    private List<IASTInitializerClause> expressionList()
            throws EndOfFileException, BacktrackException
    {
     ...
     *   braced-init-list
     */
    private IASTInitializerClause initClause(boolean allowSkipping)
            throws EndOfFileException,
            BacktrackException
    {
        // braced-init-list
     ...
     *     { }
     */
    private ICPPASTInitializerList bracedInitList(boolean allowSkipping)
            throws EndOfFileException, BacktrackException
    {
     ...
     */
    private List<IASTInitializerClause> initializerList(boolean allowSkipping)
            throws EndOfFileException,
            BacktrackException
    {
    ...
    @Override
    protected ICPPASTTypeId typeId(DeclarationOptions option)
            throws EndOfFileException, BacktrackException
    {
            ...
            throws EndOfFileException, BacktrackException
    {
        ...
        for (; ; ) {
            ...
            loop:
            while (LTcatchEOF(coloncolon + 1) == IToken.tIDENTIFIER) {
     ...
     */
    private ICPPASTFieldDeclarator bitFieldDeclarator()
            throws EndOfFileException, BacktrackException
    {
     ...
     */
    private void baseClause(ICPPASTCompositeTypeSpecifier astClassSpec)
            throws EndOfFileException, BacktrackException
    {
        consume(IToken.tCOLON);
        for (; ; ) {
    ...
    @Override
    protected void setupTranslationUnit()
            throws DOMException
    {
    ...
    protected IASTStatement parseTryStatement()
            throws EndOfFileException, BacktrackException
    {
    ...
    protected IASTNode cppStyleCondition(int expectToken)
            throws BacktrackException, EndOfFileException
    {
    ...
    protected IASTStatement parseIfStatement()
            throws EndOfFileException, BacktrackException
    {
    ...
    @Override
    protected IASTCompoundStatement functionBody()
            throws EndOfFileException, BacktrackException
    {
        ++functionBodyCount;
        try {
    ...
    protected IASTStatement parseSwitchStatement()
            throws EndOfFileException, BacktrackException
    {
        int startOffset;
    ...
    protected IASTStatement parseForStatement()
            throws EndOfFileException, BacktrackException
    {
    ...
    //		expression
    //		braced-init-list
    private ICPPASTRangeBasedForStatement startRangeBasedForLoop()
            throws EndOfFileException, BacktrackException
    {
        List<IASTAttributeSpecifier> attributes = attributeSpecifierSeq();
    ...
    private IASTForStatement startTraditionalForLoop()
            throws BacktrackException, EndOfFileException
    {
    ...
    @Override
    protected IASTStatement parseReturnStatement()
            throws EndOfFileException, BacktrackException
    {
    ...
    @Override
    protected IASTExpression expressionWithOptionalTrailingEllipsis()
            throws BacktrackException,
            EndOfFileException
    {
