...
import org.eclipse.cdt.core.dom.parser.ASTToken;
import org.eclipse.cdt.core.dom.parser.ASTTokenList;
import org.eclipse.cdt.core.dom.parser.GCCASTAttributeSpecifier;
import org.eclipse.cdt.core.dom.parser.NodeFactory;
import org.eclipse.cdt.core.parser.scanner.CPreprocessor;

/**
 * Abstract factory implementation that creates C++ AST nodes.
 */
public class CPPNodeFactory
        extends NodeFactory
        implements ICPPNodeFactory
{
