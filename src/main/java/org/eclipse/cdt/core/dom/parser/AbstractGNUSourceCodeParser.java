        ...
        implements ISourceCodeParser
{
     ...
     */
    private final IToken fetchToken(boolean skipInactive)
    ...
    private final IToken nextToken(boolean skipInactive)
            throws EndOfFileException
    {
    ...
    private final IToken lookaheadToken(int i, boolean skipInactive)
            throws EndOfFileException
    {
        assert i >= 0;
        if (isCancelled) {
     ...
     */
    protected final IToken LA(int i)
            throws EndOfFileException
    {
     ...
     */
    protected final IToken consume()
            throws EndOfFileException
    {
        IToken t = nextToken(true);
        checkForEOI(t);
    ...
    protected final void skipInactiveCode()
    ...
    private final void checkForEOI(IToken t)
            throws EndOfFileException
    {
     ...
     */
    protected final IToken consume(int type)
     ...
     */
    protected final IToken consume(int type1, int type2)
            throws EndOfFileException, BacktrackException
    {
        final IToken result = consume();
     ...
     *             if LT(1) != type
     */
    protected IToken consumeOrEOC(int type)
            throws EndOfFileException, BacktrackException
    {
     ...
     */
    protected abstract IASTName identifier()
            throws EndOfFileException, BacktrackException;
    ...
    protected final void throwBacktrack(IASTProblem problem, IASTNode node)
            throws BacktrackException
    {
        ++backtrackCount;
    ...
    protected final void throwBacktrack(IASTNode node)
            throws BacktrackException
    {
    ...
    protected IToken skipOverCompoundStatement(boolean hasSkippedNodes)
    ...
    protected abstract IASTExpression expression()
            throws BacktrackException, EndOfFileException;

    protected abstract IASTExpression constantExpression()
            throws BacktrackException, EndOfFileException;
    ...
    protected abstract IASTTypeId typeId(DeclarationOptions option)
            throws EndOfFileException, BacktrackException;
    ...
    private final static class CastAmbiguityMarker
            extends ASTNode
    ...
    protected abstract void setupTranslationUnit()
            throws Exception;
    ...
    protected final void declarationListInBraces(final IASTDeclarationListOwner tu, int offset, DeclarationOptions options)
            throws EndOfFileException, BacktrackException
    {
    ...
    protected IASTStatement handleFunctionBody()
            throws BacktrackException, EndOfFileException
    {
        declarationMark = null;
        if (mode == ParserMode.QUICK_PARSE || mode == ParserMode.STRUCTURAL_PARSE || !isActiveCode()) {
    ...
    protected int enumBody(final IASTEnumerationSpecifier result)
            throws EndOfFileException, BacktrackException
    {
    ...
    protected abstract IASTStatement statement()
            throws EndOfFileException, BacktrackException;

    protected IASTExpression condition(boolean followedByParenthesis)
            throws BacktrackException, EndOfFileException
    {
        IToken mark = mark();
        try {
     ...
     */
    protected abstract Decl declSpecifierSeq(DeclarationOptions option)
            throws BacktrackException, EndOfFileException;
     ...
     */
    protected Decl declSpecifierSequence_initDeclarator(final DeclarationOptions option, boolean acceptCompoundWithoutDtor)
    ...
    protected IASTDeclaration[] problemDeclaration(int offset, BacktrackException bt, DeclarationOptions option)
    {
        ...
        if (declarationMark != null && isActiveCode()) {
            ...
            int endOffset = 0;
            loop:
            while (declarationMark != null && declarationMark.getType() == IToken.tIDENTIFIER) {
    ...
    protected IASTDeclaration asmDeclaration()
            throws EndOfFileException, BacktrackException
    {
    ...
    protected IASTDeclaration functionStyleAsmDeclaration()
            throws BacktrackException, EndOfFileException
    {
        final int offset = LA(1).getOffset();
    ...
    protected IToken asmExpression(StringBuilder content)
            throws EndOfFileException, BacktrackException
    {
    ...
    protected IASTStatement parseLabelStatement()
            throws EndOfFileException, BacktrackException
    {
        int offset = LA(1).getOffset();
    ...
    protected IASTStatement parseNullStatement()
            throws EndOfFileException, BacktrackException
    {
    ...
    protected IASTStatement parseGotoStatement()
            throws EndOfFileException, BacktrackException
    {
    ...
    protected IASTStatement parseBreakStatement()
            throws EndOfFileException, BacktrackException
    {
    ...
    protected IASTStatement parseSwitchBody()
            throws EndOfFileException, BacktrackException
    {
    ...
    protected IASTStatement parseContinueStatement()
            throws EndOfFileException, BacktrackException
    {
    ...
    protected IASTStatement parseDoStatement()
            throws EndOfFileException, BacktrackException
    {
        int startOffset;
    ...
    protected IASTStatement parseCompoundStatement()
            throws EndOfFileException, BacktrackException
    {
    ...
    protected IASTStatement parseDefaultStatement()
            throws EndOfFileException, BacktrackException
    {
    ...
    protected IASTStatement parseCaseStatement()
            throws EndOfFileException, BacktrackException
    {
    ...
    protected void throwBacktrack(IToken token)
            throws BacktrackException
    {
    ...
    protected IASTStatement forInitStatement()
            throws BacktrackException, EndOfFileException
    {
        if (LT(1) == IToken.tSEMI) {
     ...
     * @throws EndOfFileException
     */
    protected IASTAttributeSpecifier __attribute__()
            throws BacktrackException, EndOfFileException
    {
    ...
    protected IASTAttribute singleAttribute()
            throws EndOfFileException, BacktrackException
    {
    ...
    protected IToken identifierOrKeyword()
            throws EndOfFileException, BacktrackException
    {
        IToken t = LA(1);
     ...
     * @throws EndOfFileException
     */
    protected void handleOtherDeclSpecModifier()
            throws BacktrackException, EndOfFileException
    {
    ...
    protected boolean canBeCompoundLiteral()
            throws EndOfFileException
    {
        IToken m = mark();
        try {
    ...
    protected boolean canBeCastExpression()
            throws EndOfFileException
    {
        IToken m = mark();
        try {
    ...
    protected boolean canBeTypeSpecifier()
            throws EndOfFileException
    {
        final int lt1 = LT(1);
        switch (lt1) {
    ...
    protected void skipBrackets(int left, int right, int terminator)
            throws EndOfFileException, BacktrackException
    {
        consume(left);
        int nesting = 0;
    ...
    protected IASTAlignmentSpecifier alignmentSpecifier()
            throws BacktrackException, EndOfFileException
    {
