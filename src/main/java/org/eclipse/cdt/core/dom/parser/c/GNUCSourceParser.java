        ...
        extends AbstractGNUSourceCodeParser
{
    ...
    private List<? extends ICASTDesignator> designatorList()
            throws EndOfFileException, BacktrackException
    {
        final int lt1 = LT(1);
    ...
    private IASTExpression expression(final ExprKind kind)
            throws EndOfFileException, BacktrackException
    {
    ...
    @Override
    protected IASTTypeId typeId(DeclarationOptions option)
            throws EndOfFileException, BacktrackException
    {
    ...
    @Override
    protected Decl declSpecifierSeq(final DeclarationOptions declOption)
            throws BacktrackException, EndOfFileException
    {
    ...
    protected IASTElaboratedTypeSpecifier elaboratedTypeSpecifier()
            throws BacktrackException, EndOfFileException
    {
    ...
    private IASTDeclarator declarator(final List<IASTPointerOperator> pointerOps,
            ...
            final DeclarationOptions option)
            throws EndOfFileException, BacktrackException
    {
     ...
     */
    private IASTArrayDeclarator arrayDeclarator()
            throws EndOfFileException, BacktrackException
    {
     ...
     */
    private IASTFieldDeclarator bitFieldDeclarator()
            throws EndOfFileException, BacktrackException
    {
