...
import org.eclipse.cdt.core.dom.rewrite.ASTRewriteAnalyzer;
import org.eclipse.cdt.core.dom.rewrite.astwriter.ASTWriter;
import org.eclipse.cdt.core.dom.rewrite.astwriter.ContainerNode;
import org.eclipse.cdt.core.dom.rewrite.astwriter.ProblemRuntimeException;
        ...
        extends ASTVisitor
{
    ...
    public void generateChange(IASTNode rootNode)
