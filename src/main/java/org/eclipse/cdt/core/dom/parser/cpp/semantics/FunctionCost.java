...
import static org.eclipse.cdt.core.dom.parser.cpp.semantics.CPPTemplates.TypeSelection.PARAMETERS;
import static org.eclipse.cdt.core.dom.parser.cpp.semantics.CPPTemplates.TypeSelection.RETURN_TYPE;
...
class FunctionCost
{
    ...
    public boolean performUDC(IASTNode point)
            throws DOMException
    {
     ...
     */
    public int compareTo(IASTTranslationUnit tu, FunctionCost other)
            throws DOMException
    {
        if (other == null) {
            return -1;
