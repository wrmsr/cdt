...
public class CPPTemplateTypeParameterParser
        extends PrsStream
        implements RuleAction, ITokenStream,
        ...
        , ISecondaryParser<ICPPASTTemplateParameter>
{
    ...
    public CPPTemplateTypeParameterParser(ITokenStream stream, Map<String, String> properties)
    {  // constructor for creating secondary parser
        initActions(properties);
        tokenMap = new TokenMap(CPPTemplateTypeParameterParsersym.orderedTerminalSymbols, stream.getOrderedTerminalSymbols());
    }

    public CPPTemplateTypeParameterParser(ITokenStream stream, IScanner scanner, IBuiltinBindingsProvider builtinBindingsProvider, IIndex index, Map<String, String> properties)
    {  // constructor for creating secondary parser
        initActions(properties);
        action.initializeTranslationUnit(scanner, builtinBindingsProvider, index);
        tokenMap = new TokenMap(CPPTemplateTypeParameterParsersym.orderedTerminalSymbols, stream.getOrderedTerminalSymbols());
