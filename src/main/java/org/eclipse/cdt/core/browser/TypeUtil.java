...
public class TypeUtil
{
     ...
     */
    public static ICElement[] getTypes(ITranslationUnit tu)
     ...
     *		exception occurs while accessing its corresponding resource
     */
    public static ICElement[] getAllTypes(ITranslationUnit tu)
            throws CModelException
    {
...
//  TODO move methods to CModelUtil
    public static IMethodDeclaration findMethod(String name, String[] paramTypes, boolean isConstructor, boolean isDestructor, IMethodDeclaration[] methods)
            throws CModelException
    {
     ...
     */
//TODO move methods to CModelUtil
    public static boolean isSameMethodSignature(String name, String[] paramTypes, boolean isConstructor, boolean isDestructor, IMethodDeclaration curr)
            throws CModelException
    {
     ...
     */
//	TODO move methods to CModelUtil
    public static IMethodDeclaration findMethod(String name, String[] paramTypes, boolean isConstructor, boolean isDestructor, ICElement type)
            throws CModelException
    {
