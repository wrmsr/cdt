        ...
        implements ITypeInfo, IFunctionInfo
{
    ...
    private IIndexBinding[] findBindings()
    ...
    private IndexTypeReference createReference(IIndexBinding binding, IIndexName indexName)
            throws CoreException
    {
    ...
    private IndexTypeReference createReference(IIndexMacro macro)
            throws CoreException
    {
     ...
     */
    private boolean checkFile(HashMap<IIndexFileLocation, IIndexFile> iflMap, IIndexFile file)
            throws CoreException
    {
