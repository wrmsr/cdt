        ...
        extends IAdaptable
{
     ...
     * An executable.
     */
    interface IBinaryExecutable
            extends IBinaryObject
    {
     ...
     * A DLL.
     */
    interface IBinaryShared
            extends IBinaryExecutable
    {
        /**
     ...
     * @throws IOException
     */
    IBinaryFile getBinary(byte[] hints, IPath path)
            throws IOException;
     ...
     * @throws IOException
     */
    IBinaryFile getBinary(IPath path)
            throws IOException;
