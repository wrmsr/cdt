        ...
        extends PDOMNode
{
    ...
    public PDOMNamedNode(PDOMLinkage linkage, PDOMNode parent, char[] name)
     ...
     * For linkages, only.
     */
    protected PDOMNamedNode(Database db, char[] name)
            throws CoreException
    {
        super(db);
        fName = name;
    ...
    public IString getDBName()
            throws CoreException
    {
        return getDBName(getDB(), record);
    }

    public static IString getDBName(Database db, long record)
            throws CoreException
    {
    ...
    public boolean hasName(char[] name)
            throws CoreException
    {
        if (fName != null) {
     ...
     * @throws CoreException
     */
    protected void updateName(char[] nameCharArray)
            throws CoreException
    {
    ...
    public IIndexFragmentBinding getParentBinding()
            throws CoreException
    {
