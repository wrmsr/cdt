        ...
        implements IIndexFragmentInclude
{
    ...
    public PDOMInclude(PDOMLinkage linkage, IASTPreprocessorIncludeStatement include,
            PDOMFile containerFile, PDOMFile targetFile)
    ...
    private void removeThisFromIncludedByChain()
            throws CoreException
    {
    ...
    @Override
    public IIndexFragmentFile getIncludes()
            throws CoreException
    {
    ...
    void setIncludes(PDOMFile includedFile)
            throws CoreException
    {
     ...
     */
    private static boolean isDeducibleName(PDOMFile includedFile, char[] name)
            throws CoreException
    {
    ...
    void setIncludedBy(PDOMFile includedBy)
            throws CoreException
    {
    ...
    public PDOMInclude getNextInIncludes()
            throws CoreException
    {
    ...
    public void setNextInIncludes(PDOMInclude include)
            throws CoreException
    {
    ...
    public PDOMInclude getNextInIncludedBy()
            throws CoreException
    {
    ...
    public void setNextInIncludedBy(PDOMInclude include)
            throws CoreException
    {
        long rec = include != null ? include.getRecord() : 0;
    ...
    public PDOMInclude getPrevInIncludedBy()
            throws CoreException
    {
    ...
    long getPrevInIncludedByRecord()
            throws CoreException
    {
        return linkage.getDB().getRecPtr(record + INCLUDED_BY_PREV);
    }

    public void setPrevInIncludedBy(PDOMInclude include)
            throws CoreException
    {
        long rec = include != null ? include.getRecord() : 0;
    ...
    public void convertToUnresolved()
            throws CoreException
    {
        if (isResolved()) {
            final Database db = linkage.getDB();
