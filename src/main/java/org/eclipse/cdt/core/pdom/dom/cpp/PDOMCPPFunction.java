...
import org.eclipse.cdt.core.dom.parser.ProblemFunctionType;
import org.eclipse.cdt.core.dom.parser.cpp.CPPFunction;
import org.eclipse.cdt.core.dom.parser.cpp.ICPPComputableFunction;
import org.eclipse.cdt.core.dom.parser.cpp.ICPPEvaluation;
import org.eclipse.cdt.core.index.IIndexCPPBindingConstants;
import org.eclipse.cdt.core.index.IndexCPPSignatureUtil;
import org.eclipse.cdt.core.pdom.db.Database;
import org.eclipse.cdt.core.pdom.dom.IPDOMOverloader;
...
class PDOMCPPFunction
        ...
        implements ICPPFunction, IPDOMOverloader, ICPPComputableFunction
{
    ...
    private void storeExceptionSpec(IType[] exceptionSpec)
            throws CoreException
    {
    ...
    private void setParameters(ICPPParameter[] params)
            throws CoreException
    {
    ...
    private void setType(ICPPFunctionType ft)
            throws CoreException
    {
        fType = null;
    ...
    public static int getSignatureHash(PDOMLinkage linkage, long record)
            throws CoreException
    {
    ...
    private PDOMCPPParameter getFirstParameter(IType type)
            throws CoreException
    {
