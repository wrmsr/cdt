 ...
 *******************************************************************************/
package org.eclipse.cdt.core.pdom.tag;
        ...
        implements IWritableTag
{
    ...
    private static enum Fields
    {
        ...
        public long getRecPtr(Database db, long instance, long data_offset)
        ...
        public byte getByte(Database db, long instance, long data_offset)
                throws CoreException
        {
        ...
        public int getInt(Database db, long instance, long data_offset)
                throws CoreException
        {
    ...
    public PDOMTag(Database db, int dataLen)
            throws CoreException
    {
        this.db = db;
     ...
     */
    public PDOMTag cloneWith(byte[] data)
            throws CoreException
    {
            ...
            implements IBTreeVisitor
    {
        ...
        @Override
        public int compare(long record1)
                throws CoreException
        {
            long node1 = Fields.Node.getRecPtr(db, record1, 0);
            if (node1 < node2) {
    ...
    public void setTaggerId(long idRecord)
            throws CoreException
    {
