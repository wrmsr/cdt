...
import org.eclipse.cdt.core.index.IWritableIndex.IncludeInformation;
import org.eclipse.cdt.core.index.IWritableIndexFragment;
import org.eclipse.cdt.core.index.IndexFileLocation;
import org.eclipse.cdt.core.parser.scanner.SignificantMacros;
import org.eclipse.cdt.core.pdom.PDOM;
import org.eclipse.cdt.core.pdom.YieldableIndexLock;
        ...
        implements IIndexFragmentFile
{
            ...
            implements IBTreeComparator
    {
        ...
        private IString getString(long offset)
                throws CoreException
        {
     ...
     * @throws CoreException
     */
    public void replaceContentsFrom(PDOMFile sourceFile)
            throws CoreException
    {
    ...
    @Override
    public void transferIncluders(IIndexFragmentFile sourceFile)
            throws CoreException
    {
    ...
    @Override
    public void transferContext(IIndexFragmentFile sourceFile)
            throws CoreException
    {
        PDOMFile source = (PDOMFile) sourceFile;
        PDOMInclude include = source.getFirstIncludedBy();
    ...
    @Override
    public void setSourceReadTime(long time)
            throws CoreException
    {
        Database db = fLinkage.getDB();
    ...
    @Override
    public int getSizeAndEncodingHashcode()
            throws CoreException
    {
        Database db = fLinkage.getDB();
    ...
    @Override
    public void setSizeAndEncodingHashcode(int hashcode)
            throws CoreException
    {
        Database db = fLinkage.getDB();
    ...
    private void setFirstName(PDOMName firstName)
            throws CoreException
    {
    ...
    private PDOMMacroReferenceName getFirstMacroReference()
            throws CoreException
    {
    ...
    private void setFirstMacroReference(PDOMMacroReferenceName firstName)
            throws CoreException
    {
        long namerec = firstName != null ? firstName.getRecord() : 0;
    ...
    public PDOMInclude getFirstInclude()
            throws CoreException
    {
    ...
    public void setFirstInclude(PDOMInclude include)
            throws CoreException
    {
    ...
    public PDOMInclude getFirstIncludedBy()
            throws CoreException
    {
    ...
    public void setFirstIncludedBy(PDOMInclude includedBy)
            throws CoreException
    {
    ...
    public PDOMMacro getFirstMacro()
            throws CoreException
    {
    ...
    public void setFirstMacro(PDOMMacro macro)
            throws CoreException
    {
    ...
    public void addMacros(IASTPreprocessorStatement[] macros)
            throws CoreException
    {
...
//			}
    ...
    public void addIncludesTo(IncludeInformation[] includeInfos)
            throws CoreException
    {
    ...
    public void addIncludedBy(PDOMInclude include, boolean isContext)
            throws CoreException
    {
    ...
    @Override
    public boolean hasUnresolvedInclude()
            throws CoreException
    {
        PDOMInclude include = getFirstInclude();
        while (include != null) {
    ...
    public static IIndexFragmentFile[] findFiles(PDOMLinkage linkage, BTree btree, IIndexFileLocation location,
            IIndexLocationConverter strategy)
            throws CoreException
    {
     ...
     */
    public static PDOMFile findFile(PDOMLinkage linkage, BTree btree, IIndexFileLocation location,
            IIndexLocationConverter strategy, ISignificantMacros macroDictionary)
            throws CoreException
    {
        String internalRepresentation = strategy.toInternalFormat(location);
        if (internalRepresentation != null) {
    ...
    public static PDOMFile recreateFile(PDOM pdom, final long record)
            throws CoreException
    {
    ...
    public void convertIncludersToUnresolved()
            throws CoreException
    {
        // Remove the includes
    ...
    public long getLastUsingDirectiveRec()
            throws CoreException
    {
        return fLinkage.getDB().getRecPtr(record + LAST_USING_DIRECTIVE);
    }

    public void setLastUsingDirective(long rec)
            throws CoreException
    {
    ...
    @Override
    public String getReplacementHeader()
            throws CoreException
    {
        Database db = fLinkage.getDB();
    ...
    @Override
    public void setReplacementHeader(String replacementHeader)
            throws CoreException
    {
        Database db = fLinkage.getDB();
