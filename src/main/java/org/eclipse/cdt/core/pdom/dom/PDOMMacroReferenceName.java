        ...
        implements IIndexFragmentName, IASTFileLocation
{
    ...
    private PDOMMacroReferenceName getNameField(int offset)
            throws CoreException
    {
    ...
    private void setNameField(int offset, PDOMMacroReferenceName name)
            throws CoreException
    {
    ...
    PDOMMacroReferenceName getPrevInContainer()
            throws CoreException
    {
        return getNameField(CONTAINER_PREV_OFFSET);
    }

    void setPrevInContainer(PDOMMacroReferenceName name)
            throws CoreException
    {
        setNameField(CONTAINER_PREV_OFFSET, name);
    }

    public PDOMMacroReferenceName getNextInContainer()
            throws CoreException
    {
        return getNameField(CONTAINER_NEXT_OFFSET);
    }

    void setNextInContainer(PDOMMacroReferenceName name)
            throws CoreException
    {
    ...
    PDOMMacroReferenceName getNextInFile()
            throws CoreException
    {
        return getNameField(FILE_NEXT_OFFSET);
    }

    void setNextInFile(PDOMMacroReferenceName name)
            throws CoreException
    {
