...
import org.eclipse.cdt.core.Util;
import org.eclipse.cdt.core.dom.ast.tag.TagManager;
import org.eclipse.cdt.core.dom.parser.ASTInternal;
import org.eclipse.cdt.core.dom.parser.ISerializableEvaluation;
import org.eclipse.cdt.core.dom.parser.ITypeMarshalBuffer;
...
import org.eclipse.cdt.core.dom.parser.cpp.CPPClosureType;
import org.eclipse.cdt.core.dom.parser.cpp.CPPDeferredClassInstance;
import org.eclipse.cdt.core.dom.parser.cpp.CPPFunction;
import org.eclipse.cdt.core.dom.parser.cpp.CPPFunctionType;
import org.eclipse.cdt.core.dom.parser.cpp.CPPImplicitMethod;
...
import org.eclipse.cdt.core.dom.parser.cpp.CPPQualifierType;
import org.eclipse.cdt.core.dom.parser.cpp.CPPReferenceType;
import org.eclipse.cdt.core.dom.parser.cpp.CPPUnaryTypeTransformation;
import org.eclipse.cdt.core.dom.parser.cpp.CPPUnknownClassInstance;
import org.eclipse.cdt.core.dom.parser.cpp.CPPUnknownMember;
...
import org.eclipse.cdt.core.dom.parser.cpp.ICPPInternalEnumerator;
...
import org.eclipse.cdt.core.dom.parser.cpp.semantics.EvalBinary;
import org.eclipse.cdt.core.dom.parser.cpp.semantics.EvalBinaryTypeId;
import org.eclipse.cdt.core.dom.parser.cpp.semantics.EvalBinding;
import org.eclipse.cdt.core.dom.parser.cpp.semantics.EvalComma;
import org.eclipse.cdt.core.dom.parser.cpp.semantics.EvalCompound;
import org.eclipse.cdt.core.dom.parser.cpp.semantics.EvalConditional;
import org.eclipse.cdt.core.dom.parser.cpp.semantics.EvalFixed;
import org.eclipse.cdt.core.dom.parser.cpp.semantics.EvalFunctionCall;
import org.eclipse.cdt.core.dom.parser.cpp.semantics.EvalFunctionSet;
import org.eclipse.cdt.core.dom.parser.cpp.semantics.EvalID;
import org.eclipse.cdt.core.dom.parser.cpp.semantics.EvalInitList;
import org.eclipse.cdt.core.dom.parser.cpp.semantics.EvalMemberAccess;
import org.eclipse.cdt.core.dom.parser.cpp.semantics.EvalParameterPack;
import org.eclipse.cdt.core.dom.parser.cpp.semantics.EvalTypeId;
import org.eclipse.cdt.core.dom.parser.cpp.semantics.EvalUnary;
import org.eclipse.cdt.core.dom.parser.cpp.semantics.EvalUnaryTypeID;
import org.eclipse.cdt.core.dom.parser.cpp.semantics.TypeOfDependentExpression;
import org.eclipse.cdt.core.dom.parser.cpp.semantics.TypeOfUnknownMember;
import org.eclipse.cdt.core.index.IIndexBindingConstants;
import org.eclipse.cdt.core.index.IIndexCPPBindingConstants;
import org.eclipse.cdt.core.index.composite.CompositeIndexBinding;
...
import org.eclipse.cdt.core.pdom.dom.IPDOMMemberOwner;
import org.eclipse.cdt.core.pdom.dom.PDOMASTAdapter;
import org.eclipse.cdt.core.pdom.dom.PDOMBinding;
import org.eclipse.cdt.core.pdom.dom.PDOMFile;
import org.eclipse.cdt.core.pdom.dom.PDOMGlobalScope;
...
import org.eclipse.cdt.core.pdom.dom.TypeMarshalBuffer;
 ...
 */
class PDOMCPPLinkage
        extends PDOMLinkage
        implements IIndexCPPBindingConstants
{
    ...
    // Binding types
    class ConfigureTemplateParameters
            implements Runnable
    {
    ...
    class ConfigurePartialSpecialization
            implements Runnable
    {
    ...
    class ConfigureFunctionSpecialization
            implements Runnable
    {
    ...
    class ConfigureFunctionTemplate
            implements Runnable
    {
            ...
            implements Runnable
    {
        ...
        public ConfigureAliasTemplate(ICPPAliasTemplate original, PDOMCPPAliasTemplate template)
                throws DOMException
        {
            fTemplate = template;
            fTemplateParameters = template.getTemplateParameters();
     ...
     */
    private PDOMBinding addBinding(IBinding inputBinding, IASTName fromName)
            throws CoreException
    {
    ...
    @Override
    public void addChild(PDOMNode node)
            throws CoreException
    {
        super.addChild(node);
    ...
    private void addImplicitMethods(PDOMBinding type, ICPPClassType binding, IASTNode point)
            throws CoreException
    {
        try {
    ...
    @Override
    protected boolean cannotAdapt(final IBinding inputBinding)
            throws CoreException
    {
     ...
     * @throws CoreException
     */
    private final PDOMNode adaptOrAddParent(boolean add, IBinding binding)
            throws CoreException
    {
    ...
    private PDOMBinding adaptOrAddBinding(boolean add, IBinding binding)
            throws CoreException
    {
        if (add) {
    ...
    @Override
    public void onCreateName(PDOMFile file, IASTName name, PDOMName pdomName)
            throws CoreException
    {
    ...
    @Override
    public ICPPUsingDirective[] getUsingDirectives(PDOMFile file)
            throws CoreException
    {
        long rec = file.getLastUsingDirectiveRec();
        if (rec == 0) {
    ...
    @Override
    public void onDeleteName(PDOMName pdomName)
            throws CoreException
    {
    ...
    @Override
    protected PDOMFile getLocalToFile(IBinding binding, PDOMBinding glob)
            throws CoreException
    {
        PDOM pdom = getPDOM();
    ...
    @Override
    public PDOMBinding addTypeBinding(IBinding binding)
            throws CoreException
    {
        return addBinding(binding, null);
    }
