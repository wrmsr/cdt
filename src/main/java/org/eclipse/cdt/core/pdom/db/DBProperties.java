...
public class DBProperties
{
     ...
     */
    public DBProperties(Database db)
            throws CoreException
    {
    ...
    private static class DBProperty
    {
         ...
         * @throws CoreException
         */
        DBProperty(Database db, String key, String value)
                throws CoreException
        {
            assert key != null;
            assert value != null;
        ...
        public static DBProperty search(final Database db, final BTree index, final String key)
                throws CoreException
        {
        ...
        public static Set<String> getKeySet(final Database db, final BTree index)
                throws CoreException
        {
