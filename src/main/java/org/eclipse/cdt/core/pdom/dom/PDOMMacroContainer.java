...
public class PDOMMacroContainer
        ...
        implements IIndexMacroContainer, IPDOMBinding
{
    ...
    public PDOMMacroContainer(PDOMLinkage linkage, char[] name)
    ...
    public void addDefinition(PDOMMacro name)
            throws CoreException
    {
    ...
    public void addReference(PDOMMacroReferenceName name)
            throws CoreException
    {
    ...
    public PDOMMacro getFirstDefinition()
            throws CoreException
    {
    ...
    void setFirstDefinition(PDOMMacro macro)
            throws CoreException
    {
    ...
    public PDOMMacroReferenceName getFirstReference()
            throws CoreException
    {
    ...
    void setFirstReference(PDOMMacroReferenceName nextName)
            throws CoreException
    {
    ...
    public IIndexMacro[] getDefinitions()
            throws CoreException
    {
