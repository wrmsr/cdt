...
public class FindBinding
{
    ...
    public static class DefaultFindBindingVisitor
            implements IBTreeVisitor, IPDOMVisitor
    {
        ...
        protected boolean matches(PDOMBinding nnode)
                throws CoreException
        {
            ...
            implements IBTreeComparator
    {
        ...
        private int compare(IString nameInDB, IString nameInDB2)
                throws CoreException
        {
    ...
    public static PDOMBinding findBinding(BTree btree, final PDOMLinkage linkage, final char[] name,
            final int[] constants, final long localToFileRec)
            throws CoreException
    {
