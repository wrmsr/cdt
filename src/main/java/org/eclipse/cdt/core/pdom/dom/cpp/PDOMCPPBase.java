...
import org.eclipse.cdt.core.dom.parser.cpp.ICPPInternalBase;
 ...
 */
class PDOMCPPBase
        implements ICPPBase, ICPPInternalBase
{
    ...
    public PDOMCPPBase(PDOMLinkage linkage, ICPPBase base, PDOMName classDefName)
    ...
    public void setNextBase(PDOMCPPBase nextBase)
            throws CoreException
    {
    ...
    public PDOMCPPBase getNextBase()
            throws CoreException
    {
