...
public class BTree
{
    ...
    private long insert(Chunk pChunk, long parent, int iParent, long node, long record)
            throws CoreException
    {
    ...
    private void firstInsert(long record)
            throws CoreException
    {
    ...
    private class BTNode
    {
        ...
        private BTNode getChild(int index)
                throws CoreException
        {
            ...
            if (keyIndexInNode != -1) {
                ...
                switch (mode) {
                    ...
                    case DELMODE_DELETE_MAXIMUM:
                        ...
                        break;
                    default:
                        throw new CoreException(new Status(IStatus.ERROR, CCorePlugin.PLUGIN_ID, IStatus.OK, Messages.getString("BTree.UnknownMode"), null)); //$NON-NLS-1$
                }
    ...
    private boolean accept(long node, IBTreeVisitor visitor)
            throws CoreException
    {
     ...
     */
    private interface IBTreeVisitor2
            extends IBTreeVisitor
    {
        void preNode(long node)
                throws CoreException;

        void postNode(long node)
                throws CoreException;
    }
     ...
     * @throws CoreException
     */
    public String getInvariantsErrorReport()
            throws CoreException
    {
            ...
            implements IBTreeVisitor2
    {
        ...
        @Override
        public void postNode(long node)
                throws CoreException
        { depth--; }
