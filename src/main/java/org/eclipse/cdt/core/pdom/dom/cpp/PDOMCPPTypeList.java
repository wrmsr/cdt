...
class PDOMCPPTypeList
{
     ...
     */
    public static long putTypes(PDOMNode parent, IType[] types)
    ...
    public static IType[] getTypes(PDOMNode parent, long rec)
            throws CoreException
    {
        if (rec == 0) {
            return null;
     ...
     */
    public static void clearTypes(PDOMNode parent, final long record)
            throws CoreException
    {
        if (record == 0) {
            return;
