...
public class PDOMExternalReferencesList
{
     ...
     */
    public PDOMExternalReferencesList(PDOM pdom, long record)
     ...
     * not return null.
     */
    public IPDOMIterator<PDOMName> getIterator()
            throws CoreException
    {
