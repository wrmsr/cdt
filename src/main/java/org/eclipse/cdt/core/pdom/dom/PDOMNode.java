        ...
        implements IInternalPDOMNode
{
     ...
     */
    public static PDOMNode load(PDOM pdom, long record)
    ...
    protected PDOMNode(PDOMLinkage linkage, PDOMNode parent)
            throws CoreException
    {
     ...
     * For linkages, only.
     */
    protected PDOMNode(Database db)
            throws CoreException
    {
        this(db, null, 0);
    }

    protected PDOMNode(Database db, PDOMLinkage linkage, long parentRec)
            throws CoreException
    {
     ...
     * nodes.
     */
    public static int getNodeId(Database db, long record)
            throws CoreException
    {
     ...
     */
    public static int getNodeType(Database db, long record)
            throws CoreException
    {
        return (db.getShort(record + NODE_TYPE));
    }

    public long getParentNodeRec()
            throws CoreException
    {
