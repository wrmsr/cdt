...
import org.eclipse.cdt.core.dom.parser.cpp.CPPClassSpecialization.RecursionResolvingBinding;
        ...
        implements ICPPClassSpecialization, IPDOMMemberOwner, IPDOMCPPClassType
{
    ...
    public PDOMCPPBase getFirstBase()
            throws CoreException
    {
    ...
    private void setFlags(ICPPClassType classType)
            throws CoreException
    {
