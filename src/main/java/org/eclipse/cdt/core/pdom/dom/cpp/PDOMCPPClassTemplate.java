        ...
        implements ICPPClassTemplate, ICPPInstanceCache, IPDOMCPPTemplateParameterOwner
{
            ...
            throws CoreException, DOMException
    {
        ...
        outer:
        for (int i = 0; i < newParamLength; i++) {
    ...
    private PDOMCPPClassTemplatePartialSpecialization getFirstPartial()
            throws CoreException
    {
    ...
    public void addPartial(PDOMCPPClassTemplatePartialSpecialization partial)
            throws CoreException
    {
