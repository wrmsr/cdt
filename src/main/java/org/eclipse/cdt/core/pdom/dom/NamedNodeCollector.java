        ...
        implements IBTreeVisitor, IPDOMVisitor
{
    ...
    @Override
    final public int compare(long record)
    ...
    private int compare(IString rhsName)
            throws CoreException
    {
        int cmp;
        if (prefixLookup) {
    ...
    @Override
    final public boolean visit(long record)
            throws CoreException
    {
        if (monitor != null) {
            checkCancelled();
    ...
    @Override
    final public boolean visit(IPDOMNode node)
            throws CoreException
    {
        if (monitor != null) {
            checkCancelled();
    ...
    @Override
    final public void leave(IPDOMNode node)
            throws CoreException
    {
    }
}
