...
import org.eclipse.cdt.core.index.IIndexCBindingConstants;
import org.eclipse.cdt.core.index.IIndexFragment;
import org.eclipse.cdt.core.index.IIndexFragmentBinding;
import org.eclipse.cdt.core.index.IIndexFragmentFile;
import org.eclipse.cdt.core.index.IIndexFragmentFileSet;
import org.eclipse.cdt.core.index.IIndexFragmentInclude;
import org.eclipse.cdt.core.index.IIndexFragmentName;
...
import org.eclipse.cdt.core.pdom.dom.BindingCollector;
import org.eclipse.cdt.core.pdom.dom.FindBinding;
import org.eclipse.cdt.core.pdom.dom.IPDOMIterator;
import org.eclipse.cdt.core.pdom.dom.IPDOMLinkageFactory;
import org.eclipse.cdt.core.pdom.dom.MacroContainerCollector;
import org.eclipse.cdt.core.pdom.dom.MacroContainerPatternCollector;
import org.eclipse.cdt.core.pdom.dom.PDOMBinding;
import org.eclipse.cdt.core.pdom.dom.PDOMFile;
import org.eclipse.cdt.core.pdom.dom.PDOMInclude;
import org.eclipse.cdt.core.pdom.dom.PDOMLinkage;
import org.eclipse.cdt.core.pdom.dom.PDOMMacro;
import org.eclipse.cdt.core.pdom.dom.PDOMMacroContainer;
import org.eclipse.cdt.core.pdom.dom.PDOMMacroReferenceName;
        ...
        implements IPDOM
{
    ...
    {
        @Override
        public int compare(long record1, long record2)
    ...
    private void loadDatabase(File dbPath, ChunkCache cache)
            throws CoreException
    {
        fPath = dbPath;
    ...
    protected PDOMLinkage createLinkage(int linkageID)
            throws CoreException
    {
    ...
    public PDOMLinkage getLinkage(int linkageID)
            throws CoreException
    {
    ...
    public PDOMTagIndex getTagIndex()
            throws CoreException
    {
        if (tagIndex == null) {
     ...
     */
    public BTree getIndexOfDefectiveFiles()
            throws CoreException
    {
     ...
     */
    public BTree getIndexOfFilesWithUnresolvedIncludes()
            throws CoreException
    {
    ...
    @Override
    public IIndexFragmentFile[] getFiles(IIndexFileLocation location)
            throws CoreException
    {
    ...
    private IIndexFragmentFile[] getFiles(BTree index)
            throws CoreException
    {
    ...
    @Override
    public IIndexFragmentBinding findBinding(IASTName name)
            throws CoreException
    {
    ...
    private long getFirstLinkageRecord()
            throws CoreException
    {
    ...
    public void insertLinkage(PDOMLinkage linkage)
            throws CoreException
    {
     ...
     * @throws IllegalStateException if this PDOM is not writable
     */
    public void acquireWriteLock(int giveupReadLocks, IProgressMonitor monitor)
            throws InterruptedException
    {
    ...
    protected PDOMLinkage adaptLinkage(ILinkage linkage)
            throws CoreException
    {
    ...
    private IIndexFragmentBinding adaptBinding(IBinding binding, boolean includeLocal)
            throws CoreException
    {
        if (binding == null) {
            return null;
    ...
    public IIndexFragmentBinding findBinding(IIndexFragmentName indexName)
            throws CoreException
    {
    ...
    @Override
    public IIndexFragmentName[] findNames(IBinding binding, int options)
            throws CoreException
    {
    ...
    protected boolean isCommitted(PDOMName name)
            throws CoreException
    {
        return true;
    }

    protected boolean isCommitted(PDOMMacro name)
            throws CoreException
    {
        return true;
    }

    protected boolean isCommitted(PDOMMacroReferenceName name)
            throws CoreException
    {
        return true;
    }
    ...
    private PDOMFile adaptFile(IIndexFragmentFile file)
            throws CoreException
    {
    ...
    public IIndexFragmentBinding[] findBindings(char[] name, boolean filescope,
            boolean isCaseSensitive, IndexFilter filter, IProgressMonitor monitor)
            throws CoreException
    {
        ArrayList<IIndexFragmentBinding> result = new ArrayList<>();
        try {
    ...
    public boolean hasLastingDefinition(PDOMBinding binding)
            throws CoreException
    {
        return binding.hasDefinition();
    }

    private PDOMBinding[] getCrossLanguageBindings(IBinding binding)
            throws CoreException
    {
    ...
    private PDOMMacroContainer[] getCrossLanguageBindings(PDOMMacroContainer binding)
            throws CoreException
    {
    ...
    private PDOMBinding[] getCBindingForCPP(IBinding binding)
            throws CoreException
    {
    ...
    private PDOMBinding[] getCPPBindingForC(IBinding binding)
            throws CoreException
    {
    ...
    // For debugging lock issues
    @SuppressWarnings("nls")
    static void decReadLock(Map<Thread, DebugLockInfo> lockDebugging)
    ...
    // For debugging lock issues
    @SuppressWarnings("nls")
    private void incWriteLock(int giveupReadLocks)
            throws AssertionError
    {
    ...
    // For debugging lock issues
    private void decWriteLock(int establishReadLocks)
            throws AssertionError
    {
        DebugLockInfo info = getLockInfo(fLockDebugging);
