        ...
        implements IWritableIndexFragment
{
    ...
    @Override
    public IIndexFragmentFile commitUncommittedFile()
            throws CoreException
    {
    ...
    @Override
    public void clearUncommittedFile()
            throws CoreException
    {
        if (uncommittedFile != null) {
            try {
     ...
     * @throws CoreException
     */
    public void rewriteLocations(final IIndexLocationConverter newConverter)
            throws CoreException
    {
     ...
     * @throws CoreException
     */
    private PDOMFile getBestFile(int linkageID, IIndexFileLocation location, ITranslationUnit tu)
            throws CoreException
    {
    ...
    public PDOMFile getFileForASTNode(int linkageID, IASTNode node)
            throws CoreException
    {
