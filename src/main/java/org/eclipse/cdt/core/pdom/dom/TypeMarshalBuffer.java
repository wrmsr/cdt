...
import org.eclipse.cdt.core.dom.parser.ISerializableType;
        ...
        implements ITypeMarshalBuffer
{
    ...
    @Override
    public void marshalBinding(IBinding binding)
    ...
    @Override
    public IBinding unmarshalBinding()
            throws CoreException
    {
        int oldPos = fPos;
    ...
    @Override
    public void marshalType(IType type)
            throws CoreException
    {
        if (type instanceof ISerializableType) {
            ((ISerializableType) type).marshal(this);
    ...
    @Override
    public void marshalEvaluation(ISerializableEvaluation eval, boolean includeValues)
            throws CoreException
    {
        if (eval == null) {
            putShort(NULL_TYPE);
    ...
    @Override
    public ISerializableEvaluation unmarshalEvaluation()
            throws CoreException
    {
    ...
    @Override
    public void marshalValue(IValue value)
            throws CoreException
    {
    ...
    @Override
    public void marshalTemplateArgument(ICPPTemplateArgument arg)
            throws CoreException
    {
    ...
    @Override
    public ICPPTemplateArgument unmarshalTemplateArgument()
            throws CoreException
    {
        int oldPos = fPos;
        short firstBytes = getShort();
