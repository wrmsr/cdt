...
public final class PDOMName
        implements IIndexFragmentName, IASTFileLocation
{
    ...
    private long getRecField(int offset)
            throws CoreException
    {
        return linkage.getDB().getRecPtr(record + offset);
    }

    private void setRecField(int offset, long fieldrec)
            throws CoreException
    {
    ...
    public void setBinding(PDOMBinding binding)
            throws CoreException
    {
    ...
    private PDOMName getNameField(int offset)
            throws CoreException
    {
    ...
    private void setNameField(int offset, PDOMName name)
            throws CoreException
    {
    ...
    public PDOMName getPrevInBinding()
            throws CoreException
    {
        return getNameField(BINDING_PREV_OFFSET);
    }

    public void setPrevInBinding(PDOMName name)
            throws CoreException
    {
        setNameField(BINDING_PREV_OFFSET, name);
    }

    public PDOMName getNextInBinding()
            throws CoreException
    {
        return getNameField(BINDING_NEXT_OFFSET);
    }

    public void setNextInBinding(PDOMName name)
            throws CoreException
    {
    ...
    @Override
    public IIndexName getEnclosingDefinition()
            throws CoreException
    {
    ...
    long getEnclosingDefinitionRecord()
            throws CoreException
    {
    ...
    public void setNextInFile(PDOMName name)
            throws CoreException
    {
    ...
    private int getFlags(int mask)
            throws CoreException
    {
        return linkage.getDB().getByte(record + FLAGS) & mask;
    }

    public void setIsFriendSpecifier()
            throws CoreException
    {
    ...
    public void setIsBaseSpecifier()
            throws CoreException
    {
        int flags = linkage.getDB().getByte(record + FLAGS) & 0xff;
    ...
    public void setIsInlineNamespace()
            throws CoreException
    {
        int flags = linkage.getDB().getByte(record + FLAGS) & 0xff;
    ...
    public boolean isFriendSpecifier()
            throws CoreException
    {
    ...
    @Override
    public boolean isBaseSpecifier()
            throws CoreException
    {
    ...
    @Override
    public IIndexName[] getEnclosedNames()
            throws CoreException
    {
