...
public class PDOMCPPMemberBlock
{
    ...
    public PDOMCPPMemberBlock(PDOMLinkage linkage, long record)
    ...
    public PDOMCPPMemberBlock(PDOMLinkage linkage)
            throws CoreException
    {
    ...
    public void setNextBlock(PDOMCPPMemberBlock nextBlock)
            throws CoreException
    {
    ...
    public PDOMCPPMemberBlock getNextBlock()
            throws CoreException
    {
    ...
    private void visitBlock(IPDOMVisitor visitor)
            throws CoreException
    {
        if (record == 0) {
    ...
    private long getMemberRecord(int memberIndex)
            throws CoreException
    {
    ...
    private void setVisibility(int memberIndex, int newVisibility)
            throws CoreException
    {
    ...
    private static int getVisibility(PDOMCPPMemberBlock block, PDOMNode memberNode)
            throws CoreException
    {
    ...
    private int getVisibility(int memberIndex)
            throws CoreException
    {
        int visibilityBitOffset = memberIndex % VISIBILITY_VALUES_PER_BYTE;
        long visibilityOffset = record + MEMBER_VISIBILITIES + memberIndex / VISIBILITY_VALUES_PER_BYTE;
