...
import org.eclipse.cdt.core.index.IIndexFragmentBindingComparator;
...
import org.eclipse.cdt.core.pdom.db.PDOMExternalReferencesList;
import org.eclipse.cdt.core.pdom.tag.PDOMTaggable;
        ...
        implements IPDOMBinding
{
    ...
    protected PDOMBinding(PDOMLinkage linkage, PDOMNode parent, char[] name)
     ...
     * @throws CoreException
     */
    public static boolean isOrphaned(PDOM pdom, long record)
            throws CoreException
    {
    ...
    public final void addDeclaration(PDOMName name)
            throws CoreException
    {
    ...
    public final void addDefinition(PDOMName name)
            throws CoreException
    {
    ...
    public final void addReference(PDOMName name)
            throws CoreException
    {
    ...
    public PDOMName getFirstDeclaration()
            throws CoreException
    {
    ...
    public void setFirstDeclaration(PDOMName name)
            throws CoreException
    {
    ...
    public PDOMName getFirstDefinition()
            throws CoreException
    {
    ...
    public void setFirstDefinition(PDOMName name)
            throws CoreException
    {
        long namerec = name != null ? name.getRecord() : 0;
    ...
    public PDOMName getFirstReference()
            throws CoreException
    {
     ...
     * not return null.
     */
    public IPDOMIterator<PDOMName> getExternalReferences()
            throws CoreException
    {
     ...
     */
    public void setFirstReference(PDOMLinkage linkage, PDOMName name)
            throws CoreException
    {
    ...
    private void setFirstReference(PDOMName name)
            throws CoreException
    {
        // This needs to filter between the local and external lists because it can be used in
        // contexts that don't know which type of list they are iterating over.  E.g., this is
    ...
    @Override
    public final PDOMFile getLocalToFile()
            throws CoreException
    {
    ...
    public final long getLocalToFileRec()
            throws CoreException
    {
        return getLocalToFileRec(getDB(), record);
    }

    public static long getLocalToFileRec(Database db, long record)
            throws CoreException
    {
        return db.getRecPtr(record + LOCAL_TO_FILE);
    }

    public final void setLocalToFileRec(long rec)
            throws CoreException
    {
    ...
    @Override
    final public boolean isFileLocal()
            throws CoreException
    {
    ...
    @Override
    final public void delete(PDOMLinkage linkage)
            throws CoreException
    {
        assert false;
    }
