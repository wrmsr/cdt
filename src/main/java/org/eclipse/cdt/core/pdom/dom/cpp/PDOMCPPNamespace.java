        ...
        implements ICPPNamespace, ICPPNamespaceScope, IIndexScope
{
    ...
    public PDOMCPPNamespace(PDOMLinkage linkage, PDOMNode parent, ICPPNamespace namespace)
    ...
    public PDOMCPPNamespace(PDOMLinkage linkage, long record)
            throws CoreException
    {
    ...
    private void updateFlag(ICPPNamespace namespace)
            throws CoreException
    {
        int flag = 0;
    ...
    public void addToList(final long listRecord)
            throws CoreException
    {
    ...
    private IBinding[] getBindingsViaCache(final char[] name)
            throws CoreException
    {
