...
import org.eclipse.cdt.core.pdom.db.IString;
...
public abstract class PDOMLinkage
        ...
        implements IIndexLinkage, IIndexBindingConstants
{
    // Record offsets.
    ...
    protected PDOMLinkage(PDOM pdom, String linkageID, char[] name)
    ...
    public static IString getLinkageID(PDOM pdom, long record)
            throws CoreException
    {
    ...
    public static long getNextLinkageRecord(PDOM pdom, long record)
            throws CoreException
    {
        return pdom.getDB().getRecPtr(record + NEXT_OFFSET);
    }

    public void setNext(long nextrec)
            throws CoreException
    {
     ...
     * @throws CoreException
     */
    public BTree getNestedBindingsIndex()
            throws CoreException
    {
    ...
    @Override
    public void accept(final IPDOMVisitor visitor)
            throws CoreException
    {
    ...
    @Override
    public void addChild(PDOMNode child)
            throws CoreException
    {
        getIndex().insert(child.getRecord());
    }

    public final PDOMBinding getBinding(long record)
            throws CoreException
    {
    ...
    public abstract PDOMNode getNode(long record, int nodeType)
            throws CoreException;
    ...
    protected final PDOMBinding attemptFastAdaptBinding(final IBinding binding)
            throws CoreException
    {
    ...
    public final PDOMBinding adaptBinding(IBinding binding)
            throws CoreException
    {
        return adaptBinding(binding, true);
    }

    public abstract PDOMBinding adaptBinding(IBinding binding, boolean includeLocal)
            throws CoreException;

    public abstract PDOMBinding addBinding(IASTName name)
            throws CoreException;

    final protected long getLocalToFileRec(PDOMNode parent, IBinding binding, PDOMBinding glob)
            throws CoreException
    {
        long rec = 0;
     ...
     * @since 4.0
     */
    public void onDeleteName(PDOMName name)
            throws CoreException
    {
    }
     ...
     * @since 4.0.1
     */
    protected final void insertIntoNestedBindingsIndex(PDOMBinding pdomBinding)
            throws CoreException
    {
     ...
     * @since 4.0.1
     */
    public void beforeRemoveBinding(PDOMBinding pdomBinding)
            throws CoreException
    {
        if (pdomBinding.getParentNodeRec() != record) {
    ...
    public PDOMMacroContainer findMacroContainer(final char[] name)
            throws CoreException
    {
        return findMacroContainer(name, fPDOM.createKeyForCache(record, name));
    }

    private PDOMMacroContainer findMacroContainer(final char[] name, final String key)
            throws CoreException
    {
    ...
    public PDOMMacroContainer getMacroContainer(char[] name)
            throws CoreException
    {
    ...
    public void removeMacroContainer(PDOMMacroContainer container)
            throws CoreException
    {
     ...
     * @throws CoreException
     */
    public PDOMBinding[] getBindingsViaCache(char[] name, IProgressMonitor monitor)
            throws CoreException
    {
    ...
    public abstract PDOMBinding addTypeBinding(IBinding binding)
            throws CoreException;

    public abstract IType unmarshalType(ITypeMarshalBuffer buffer)
            throws CoreException;

    public abstract IBinding unmarshalBinding(ITypeMarshalBuffer buffer)
            throws CoreException;

    public abstract ISerializableEvaluation unmarshalEvaluation(ITypeMarshalBuffer typeMarshalBuffer)
            throws CoreException;

    public void storeType(long offset, IType type)
            throws CoreException
    {
    ...
    private void storeType(Database db, long offset, IType type)
            throws CoreException
    {
        if (type != null) {
    ...
    private void storeBuffer(Database db, long offset, TypeMarshalBuffer buf, int maxInlineSize)
            throws CoreException
    {
    ...
    private byte[] loadLinkedSerializedData(final Database db, long offset)
            throws CoreException
    {
    ...
    private void deleteSerializedData(Database db, long offset, int maxInlineSize)
            throws CoreException
    {
    ...
    private void deleteType(Database db, long offset)
            throws CoreException
    {
        deleteSerializedData(db, offset, Database.TYPE_SIZE);
    }

    public IType loadType(long offset)
            throws CoreException
    {
        final Database db = getDB();
    ...
    public void storeBinding(long offset, IBinding binding)
            throws CoreException
    {
        final Database db = getDB();
    ...
    private void storeBinding(Database db, long offset, IBinding binding)
            throws CoreException
    {
        if (binding != null) {
            TypeMarshalBuffer bc = new TypeMarshalBuffer(this);
    ...
    private void deleteBinding(Database db, long offset)
            throws CoreException
    {
        deleteSerializedData(db, offset, Database.TYPE_SIZE);
    }

    public IBinding loadBinding(long offset)
            throws CoreException
    {
        final Database db = getDB();
        final byte firstByte = db.getByte(offset);
    ...
    public void storeTemplateArgument(long offset, ICPPTemplateArgument arg)
            throws CoreException
    {
        final Database db = getDB();
    ...
    private void storeArgument(Database db, long offset, ICPPTemplateArgument arg)
            throws CoreException
    {
        if (arg != null) {
            TypeMarshalBuffer bc = new TypeMarshalBuffer(this);
    ...
    private void deleteArgument(Database db, long offset)
            throws CoreException
    {
        deleteSerializedData(db, offset, Database.ARGUMENT_SIZE);
    }

    public ICPPTemplateArgument loadTemplateArgument(long offset)
            throws CoreException
    {
        final Database db = getDB();
        final byte firstByte = db.getByte(offset);
    ...
    public void storeValue(long offset, IValue value)
            throws CoreException
    {
        final Database db = getDB();
    ...
    private void storeValue(Database db, long offset, IValue value)
            throws CoreException
    {
        if (value != null) {
            TypeMarshalBuffer bc = new TypeMarshalBuffer(this);
    ...
    private void deleteValue(Database db, long offset)
            throws CoreException
    {
        deleteSerializedData(db, offset, Database.VALUE_SIZE);
    }

    public IValue loadValue(long offset)
            throws CoreException
    {
    ...
    public void storeEvaluation(long offset, ISerializableEvaluation eval)
            throws CoreException
    {
        final Database db = getDB();
    ...
    private void storeEvaluation(Database db, long offset, ISerializableEvaluation eval)
            throws CoreException
    {
        if (eval != null) {
            TypeMarshalBuffer bc = new TypeMarshalBuffer(this);
    ...
    private void deleteEvaluation(Database db, long offset)
            throws CoreException
    {
        deleteSerializedData(db, offset, Database.EVALUATION_SIZE);
    }

    public ISerializableEvaluation loadEvaluation(long offset)
            throws CoreException
    {
    ...
    private TypeMarshalBuffer loadBuffer(long offset, int size)
            throws CoreException
    {
        final Database db = getDB();
        final byte firstByte = db.getByte(offset);
