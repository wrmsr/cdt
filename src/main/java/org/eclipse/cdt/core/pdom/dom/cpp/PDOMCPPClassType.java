...
class PDOMCPPClassType
        ...
        implements IPDOMCPPClassType, IPDOMMemberOwner
{
    ...
    private void setKind(ICPPClassType ct)
            throws CoreException
    {
        getDB().putByte(record + KEY, (byte) ct.getKey());
    }

    private void setAnonymous(ICPPClassType ct)
            throws CoreException
    {
        getDB().putByte(record + ANONYMOUS, (byte) (ct.isAnonymous() ? 1 : 0));
    }

    private void setFinal(ICPPClassType ct)
            throws CoreException
    {
    ...
    @Override
    public final void addChild(PDOMNode member)
            throws CoreException
    {
     ...
     */
    @Override
    public void acceptUncached(IPDOMVisitor visitor)
            throws CoreException
    {
    ...
    private PDOMCPPBase getFirstBase()
            throws CoreException
    {
    ...
    private void setFirstBase(PDOMCPPBase base)
            throws CoreException
    {
    ...
    public void addBases(PDOMName classDefName, ICPPBase[] bases)
            throws CoreException
    {
    ...
    public void removeBases(PDOMName classDefName)
            throws CoreException
    {
    ...
    public void addFriend(PDOMCPPFriend friend)
            throws CoreException
    {
    ...
    private PDOMCPPFriend getFirstFriend()
            throws CoreException
    {
    ...
    private void setFirstFriend(PDOMCPPFriend friend)
            throws CoreException
    {
    ...
    public void removeFriend(PDOMName pdomName)
            throws CoreException
    {
