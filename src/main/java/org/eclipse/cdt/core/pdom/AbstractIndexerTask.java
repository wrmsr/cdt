...
import org.eclipse.cdt.core.dom.IIncludeFileResolutionHeuristics;
import org.eclipse.cdt.core.dom.parser.ASTTranslationUnit;
import org.eclipse.cdt.core.index.FileContentKey;
...
import org.eclipse.cdt.core.index.IndexBasedFileContentProvider;
import org.eclipse.cdt.core.parser.IMacroDictionary;
import org.eclipse.cdt.core.parser.ParserSettings2;
import org.eclipse.cdt.core.parser.scanner.InternalFileContentProvider;
import org.eclipse.cdt.core.parser.scanner.InternalFileContentProvider.DependsOnOutdatedFileException;
import org.eclipse.cdt.core.parser.util.LRUCache;
        ...
        extends PDOMWriter
{
    ...
    private static class LocationTask
    {
        ...
        FileVersionTask findVersion(ISignificantMacros sigMacros)
    ...
    public static class IndexFileContent
    {
        ...
        public IndexFileContent(IIndexFile ifile)
                throws CoreException
        {
        ...
        public Object[] getPreprocessingDirectives()
                throws CoreException
        {
        ...
        public void setPreprocessorDirectives(IIndexInclude[] includes, IIndexMacro[] macros)
                throws CoreException
        {
        ...
        public static Object[] merge(IIndexInclude[] includes, IIndexMacro[] macros)
                throws CoreException
        {
        ...
        private static int getOffset(IIndexMacro[] macros, int m)
                throws CoreException
        {
            if (m < macros.length) {
        ...
        private static int getOffset(IIndexInclude[] includes, int i)
                throws CoreException
        {
    ...
    public final void runTask(IProgressMonitor monitor)
    ...
    private void setResume(boolean value)
    ...
    private boolean isModified(boolean checkTimestamps, boolean checkFileContentsHash, IIndexFileLocation ifl,
            Object tu, IIndexFragmentFile file)
            throws CoreException
    {
        if (checkTimestamps) {
    ...
    private void swallowError(IPath file, Throwable e)
            throws CoreException
    {
        IStatus s;
        /*
    ...
    private final IASTTranslationUnit createAST(AbstractLanguage language, FileContent codeReader,
            ...
            FileContext ctx, IProgressMonitor pm)
            throws CoreException
    {
        if (codeReader == null) {
            return null;
    ...
    private void collectOrderedFileKeys(final int linkageID, IASTInclusionNode inclusion,
            HashSet<FileContentKey> enteredFiles, ArrayList<FileInAST> orderedFileKeys)
            throws CoreException
    {
    ...
    public IIndexFile selectIndexFile(int linkageID, IIndexFileLocation ifl, IMacroDictionary md)
            throws CoreException
    {
        LinkageTask map = findRequestMap(linkageID);
        if (map != null) {
