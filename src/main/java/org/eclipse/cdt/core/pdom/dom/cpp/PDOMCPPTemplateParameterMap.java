...
public class PDOMCPPTemplateParameterMap
{
     ...
     */
    public static long putMap(PDOMNode parent, ICPPTemplateParameterMap map)
     ...
     */
    public static void clearMap(PDOMNode parent, final int record)
            throws CoreException
    {
        final PDOMLinkage linkage = parent.getLinkage();
        final Database db = linkage.getDB();
     ...
     */
    public static CPPTemplateParameterMap getMap(PDOMNode parent, long rec)
            throws CoreException
    {
        final PDOMLinkage linkage = parent.getLinkage();
        final Database db = linkage.getDB();
