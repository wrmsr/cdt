 ...
 * Richard Eames
 *******************************************************************************/
package org.eclipse.cdt.core.parser.scanner;
...
import org.eclipse.cdt.core.parser.EmptyFilesProvider;
import org.eclipse.cdt.core.parser.IMacroDictionary;
import org.eclipse.cdt.core.parser.scanner.ExpressionEvaluator.EvalException;
import org.eclipse.cdt.core.parser.scanner.InternalFileContent.FileVersion;
import org.eclipse.cdt.core.parser.scanner.InternalFileContent.InclusionKind;
...
import org.eclipse.cdt.core.parser.scanner.MacroDefinitionParser.InvalidMacroDefinitionException;
import org.eclipse.cdt.core.parser.scanner.ScannerContext.BranchKind;
import org.eclipse.cdt.core.parser.scanner.ScannerContext.CodeState;
import org.eclipse.cdt.core.parser.scanner.ScannerContext.Conditional;
        ...
        implements ILexerLog, IScanner, IAdaptable
{
    ...
    private final class MacroDictionary
            implements IMacroDictionary, ISignificantMacros.IVisitor
    {
        @Override
    ...
    private void handlePragmaOperator(Token t1)
            throws OffsetLimitReachedException
    {
        Token t2 = fetchToken();
        int end;
    ...
    private void executeInclude(final Lexer lexer, int poundOffset, int includeType,
            boolean active, boolean withinExpansion)
            throws OffsetLimitReachedException
    {
