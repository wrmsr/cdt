...
public class CodeReader
{
    ...
    public CodeReader(String filename, String charSet)
            throws IOException
    {
        this.filename = filename.toCharArray();
    ...
    public CodeReader(String filename, InputStream stream)
            throws IOException
    {
    ...
    private CharBuffer decodeSmallFile(FileChannel channel, final int isize, String encoding)
            throws IOException
    {
    ...
    private CharBuffer decodeLargeFile(FileChannel channel, final int isize, String encoding)
            throws IOException
    {
