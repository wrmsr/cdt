...
import org.eclipse.cdt.core.parser.scanner.ImageLocationInfo.MacroImageLocationInfo;
import org.eclipse.cdt.core.parser.scanner.ImageLocationInfo.ParameterImageLocationInfo;
import org.eclipse.cdt.core.parser.scanner.Lexer.LexerOptions;
import org.eclipse.cdt.core.parser.scanner.MacroDefinitionParser.TokenParameterReference;
...
public class MacroExpander
{
            ...
            extends TokenList
    {
        ...
        public boolean findLParenthesis()
                throws OffsetLimitReachedException
        {
            Token t = first();
            while (t != null) {
    ...
    private TokenList expandAll(TokenSource input, IdentityHashMap<PreprocessorMacro, PreprocessorMacro> forbidden,
            boolean protectIntrinsics, MacroExpansionTracker tracker)
            throws OffsetLimitReachedException
    {
