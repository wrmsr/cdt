...
public class ExpressionEvaluator
{
    ...
    private long conditionalExpression()
            throws EvalException
    {
    ...
    private long logicalOrExpression()
            throws EvalException
    {
    ...
    private long logicalAndExpression()
            throws EvalException
    {
    ...
    private long inclusiveOrExpression()
            throws EvalException
    {
    ...
    private long exclusiveOrExpression()
            throws EvalException
    {
    ...
    private long equalityExpression()
            throws EvalException
    {
    ...
    private long relationalExpression()
            throws EvalException
    {
    ...
    private long additiveExpression()
            throws EvalException
    {
    ...
    private long multiplicativeExpression()
            throws EvalException
    {
    ...
    public static long getNumber(char[] image)
            throws EvalException
    {
    ...
    public static long getChar(char[] tokenImage, int i)
            throws EvalException
    {
