...
import org.eclipse.cdt.core.dom.parser.ASTNodeSpecification;
...
abstract class ASTDirectiveWithCondition
        extends ASTPreprocessorNode
{
...
class ASTElif
        extends ASTDirectiveWithCondition
...
class ASTFunctionStyleMacroDefinition
        extends ASTMacroDefinition
...
class ASTInclusionNode
        implements IASTInclusionNode
{
...
class DependencyTree
        extends ASTInclusionNode
        implements IDependencyTree
{
...
class ASTMacroExpansion
        extends ASTPreprocessorNode
        implements IASTPreprocessorMacroExpansion
{
...
class ASTMacroExpansionLocation
        implements IASTMacroExpansionLocation, org.eclipse.cdt.core.dom.ast.IASTMacroExpansion
{
    private LocationCtxMacroExpansion fContext;
    private int fOffset;
    private int fLength;
...
class ASTFileLocationForBuiltins
        implements IASTFileLocation
{
...
class ASTImageLocation
        extends ASTFileLocationForBuiltins
        implements IASTImageLocation
{
