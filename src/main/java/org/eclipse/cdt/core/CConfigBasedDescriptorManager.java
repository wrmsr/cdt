...
import org.eclipse.cdt.core.settings.model.PathEntryConfigurationDataProvider;
 ...
 */
final public class CConfigBasedDescriptorManager
        implements ICDescriptorManager
{
     ...
     */
    @Override
    public void configure(IProject project, String id)
     ...
     */
    @Override
    public void convert(IProject project, String id)
            throws CoreException
    {
     ...
     */
    @Override
    public ICDescriptor getDescriptor(IProject project)
            throws CoreException
    {
     ...
     * @throws CoreException
     */
    private CConfigBasedDescriptor findDescriptor(IProject project, boolean create)
            throws CoreException
    {
...
//			Job.getJobManager().endRule(ResourcesPlugin.getWorkspace().getRoot());
    ...
    private static CProjectDescription createProjDescriptionForDescriptor(final IProject project)
            throws CoreException
    {
     ...
     * @throws CoreException
     */
    private static CConfigBasedDescriptor loadDescriptor(CProjectDescription des)
            throws CoreException
    {
        if (des == null) {
