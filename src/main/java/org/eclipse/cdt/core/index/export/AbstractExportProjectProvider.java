 ...
 */
public abstract class AbstractExportProjectProvider
        implements IExportProjectProvider
{
     ...
     * not be present, or if it does not have exactly one parameter
     */
    public String getSingleString(String option)
     ...
     * @throws CoreException
     */
    public List<String> getParameters(String option, int expected)
            throws CoreException
    {
     ...
     */
    public IStatus fail(String message)
            throws CoreException
    {
