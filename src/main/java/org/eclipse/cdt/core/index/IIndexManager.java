        ...
        extends IPDOMManager
{
     ...
     */
    IIndex getIndex(ICProject project)
            throws CoreException;
     ...
     * @throws CoreException
     */
    IIndex getIndex(ICProject[] projects)
            throws CoreException;
     ...
     * @throws CoreException
     */
    IIndex getIndex(ICProject project, int options)
            throws CoreException;
     ...
     * @throws CoreException
     */
    IIndex getIndex(ICProject[] projects, int options)
            throws CoreException;
