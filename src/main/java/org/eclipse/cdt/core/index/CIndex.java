...
import org.eclipse.cdt.core.index.composite.c.CCompositesFactory;
import org.eclipse.cdt.core.index.composite.cpp.CPPCompositesFactory;
        ...
        implements IIndex
{
    ...
    @Override
    public IIndexFile[] getFiles(int linkageID, IIndexFileLocation location)
            throws CoreException
    {
        if (location == null) {
    ...
    private static final class NameKey
    {
        ...
        NameKey(IIndexFragmentName name, boolean writable)
                throws CoreException
        {
