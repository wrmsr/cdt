...
import org.eclipse.cdt.core.pdom.ASTFilePathResolver;
        ...
        extends IIndex
{
     ...
     */
    IIndexFragmentFile[] getWritableFiles(int linkageID, IIndexFileLocation location)
            throws CoreException;
     ...
     * returns file objects without content, also.
     */
    IIndexFragmentFile[] getWritableFiles(IIndexFileLocation location)
            throws CoreException;
     ...
     */
    void clearFile(IIndexFragmentFile file)
            throws CoreException;
     ...
     * @throws CoreException
     */
    IIndexFragmentFile commitUncommittedFile()
            throws CoreException;
    ...
    void setFileContent(IIndexFragmentFile sourceFile,
            ...
            ASTFilePathResolver resolver, YieldableIndexLock lock)
     ...
     */
    void acquireWriteLock(IProgressMonitor monitor)
     ...
     */
    void transferIncluders(IIndexFragmentFile source, IIndexFragmentFile target)
            throws CoreException;
     ...
     * Both files must belong to the writable fragment.
     */
    void transferContext(IIndexFragmentFile source, IIndexFragmentFile target)
            throws CoreException;
}
