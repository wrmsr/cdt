        ...
        implements ILanguageSettingsBroadcastingProvider
{
     ...
     */
    private LanguageSettingsSerializableProvider cloneShallowInternal()
     ...
     */
    protected LanguageSettingsSerializableProvider cloneShallow()
            throws CloneNotSupportedException
    {
    ...
    @Override
    protected LanguageSettingsSerializableProvider clone()
            throws CloneNotSupportedException
    {
