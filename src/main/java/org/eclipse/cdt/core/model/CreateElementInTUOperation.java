        ...
        extends CModelOperation
{
    ...
    protected abstract String generateElement(ITranslationUnit unit)
     ...
     */
    protected ICElement[] generateResultHandles()
            throws CModelException
    {
     ...
     */
    protected void setRelativePosition(ICElement sibling, int policy)
