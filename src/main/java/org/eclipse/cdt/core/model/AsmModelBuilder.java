        ...
        implements IContributedModelBuilder
{
     ...
     */
    private void buildModel(final char[] source)
            throws CModelException
    {
    ...
    protected void createLabel(CElement parent, IToken token)
            throws CModelException
    {
     ...
     * @throws CModelException
     */
    private void fixupLastGlobalLabel()
            throws CModelException
    {
    ...
    private void parsePPDirective(CElement parent)
            throws CModelException
    {
        IToken token = nextToken();
        if (token != null && token.getType() == IToken.tIDENTIFIER) {
