        ...
        implements IBinary
{
    ...
    private void addFunction(OpenableInfo info, ISymbol symbol, Map<IPath, BinaryModule> hash)
            throws CModelException
    {
    ...
    private void addVariable(OpenableInfo info, ISymbol symbol, Map<IPath, BinaryModule> hash)
            throws CModelException
    {
        IPath filename = symbol.getFilename();
