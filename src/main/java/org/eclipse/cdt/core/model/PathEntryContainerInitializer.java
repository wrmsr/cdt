...
public abstract class PathEntryContainerInitializer
{
    ...
    public abstract void initialize(IPath containerPath, ICProject project)
     ...
     */
    public void requestPathEntryContainerUpdate(IPath containerPath, ICProject project, IPathEntryContainer containerSuggestion)
            throws CoreException
    {
