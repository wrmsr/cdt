        ...
        extends CConfigurationDataProvider
{
    ...
    private CConfigurationData createData(ICConfigurationDescription cfgDescription, CConfigurationData fallbackData, boolean modifiedFlag, boolean useCache)
            throws CoreException
    {
    ...
    public CConfigurationData createConfiguration(ICConfigurationDescription cfgDescription,
            ICConfigurationDescription baseCfgDescription, CConfigurationData baseData,
            boolean clone, IProgressMonitor monitor)
            throws CoreException
    {
    ...
    private CfgData createData(ICConfigurationDescription cfgDescription, boolean useCache)
            throws CoreException
    {
        IProject project = cfgDescription.getProjectDescription().getProject();
        CModelManager manager = CModelManager.getDefault();
