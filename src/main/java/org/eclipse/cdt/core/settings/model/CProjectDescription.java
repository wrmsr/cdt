...
public class CProjectDescription
        implements ICProjectDescription, ICDataProxyContainer
{
...
//	private String fIndexCfgId;
    ...
    public CProjectDescription(IProject project, ICSettingsStorage storage, ICStorageElement element, boolean loading, boolean isCreating)
...
//		fIsApplying = false;
     ...
     */
    void switchToCachedConfigurationDescriptions()
            throws CoreException
    {
    ...
    @Override
    public ICStorageElement getStorage(String moduleId, boolean create)
            throws CoreException
    {
...
//	}
    ...
    public ICStorageElement getRootStorageElement()
            throws CoreException
    {
...
//	}
    ...
    ICSettingsStorage getStorageBase()
            throws CoreException
    {
        if (fStorage == null)
