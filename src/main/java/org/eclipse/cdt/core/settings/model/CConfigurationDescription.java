...
//	private ProxyProvider fRcProxyProvider;
    ...
    CConfigurationDescription(CConfigurationData data, ICDataProxyContainer cr)
...
//			fCfgSpecSettings = CProjectDescriptionManager.getInstance().createConfigurationSpecSettings(this);
    ...
    @Override
    public void setConfigurationData(String buildSystemId, CConfigurationData data)
            throws WriteAccessException
    {
        String oldId = getId();
        setData(data);
