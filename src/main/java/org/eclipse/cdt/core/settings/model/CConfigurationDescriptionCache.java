        ...
        implements ICConfigurationDescription, IInternalCCfgInfo, ILanguageSettingsProvidersKeeper, ICachedData
{
    ...
    CConfigurationDescriptionCache(ICStorageElement storage, CProjectDescription parent)
...
//		fInitializing = false;
    ...
    CConfigurationDescriptionCache(ICConfigurationDescription baseDescription, CConfigurationData base, CConfigurationDescriptionCache baseCache, CConfigurationSpecSettings settingsBase, CProjectDescription parent, ICStorageElement rootEl)
            throws CoreException
    {
...
//			fData = base;
    ...
    boolean applyData(SettingsContext context)
            throws CoreException
    {
    ...
    @Override
    public void removeResourceData(CResourceData data)
            throws CoreException
    {
        throw ExceptionFactory.createIsReadOnlyException();
    }
    ...
    @Override
    public void setConfigurationData(String bsId, CConfigurationData data)
            throws WriteAccessException
    {
        throw ExceptionFactory.createIsReadOnlyException();
    }
