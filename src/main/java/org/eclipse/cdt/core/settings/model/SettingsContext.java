...
import org.eclipse.cdt.core.settings.model.CProjectDescriptionManager.CompositeWorkspaceRunnable;
        ...
        implements IModificationContext
{
    ...
    IProjectDescription getEclipseProjectDescription(boolean create)
    ...
    @Override
    public IProjectDescription getEclipseProjectDescription()
            throws CoreException
    {
