...
public abstract class AbstractCProjectDescriptionStorage
{
     ...
     */
    public abstract ICSettingsStorage getStorageForElement(ICStorageElement element)
     ...
     */
    public ICStorageElement copyElement(ICStorageElement el, boolean writable)
            throws CoreException
    {
        return null;
    }
     ...
     */
    public ICProjectDescription getProjectDescription(int flags, IProgressMonitor monitor)
            throws CoreException
    {
