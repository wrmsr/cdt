...
public class CDataSerializer
{
    ...
    public CConfigurationData loadConfigurationData(CDataFactory factory, ICStorageElement el)
...
//		}
    ...
    public CFolderData loadFolderData(CConfigurationData data, CDataFactory factory, ICStorageElement el)
            throws CoreException
    {
        String id = el.getAttribute(ID);
        if (id == null) {
...
//		}
    ...
    public CFileData loadFileData(CConfigurationData data, CDataFactory factory, ICStorageElement el)
            throws CoreException
    {
        String id = el.getAttribute(ID);
        if (id == null) {
...
//		}
    ...
    public CBuildData loadBuildData(CConfigurationData data, CDataFactory factory, ICStorageElement el)
            throws CoreException
    {
        String id = el.getAttribute(ID);
        if (id == null) {
    ...
    public CTargetPlatformData loadTargetPlatformData(CConfigurationData data, CDataFactory factory, ICStorageElement el)
            throws CoreException
    {
        String id = el.getAttribute(ID);
        if (id == null) {
    ...
    public CLanguageData loadLanguageData(CConfigurationData data, CResourceData rcData, CDataFactory factory, ICStorageElement el)
            throws CoreException
    {
        String id = el.getAttribute(ID);
        if (id == null) {
    ...
    public void store(CConfigurationData data, ICStorageElement el)
            throws CoreException
    {
