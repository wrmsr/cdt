...
import org.eclipse.cdt.core.model.PathEntryManager;
...
public class ConfigBasedPathEntryStore
        implements IPathEntryStore, ICProjectDescriptionListener
{
    ...
    @Override
    public void setRawPathEntries(IPathEntry[] entries)
            throws CoreException
    {
        ICConfigurationDescription cfg = getIndexCfg(fProject);
        List<IPathEntry> es[] = getEntries(fProject, cfg);
                ...
                if (des != null) {
                    ...
                    if (oldCrEntries != null) {
                        ...
                        if (!Arrays.equals(oldCrEntries.toArray(), newCrEntries.toArray())) {
                            ...
                            try {
                                PathEntryManager.getDefault().clearPathEntryContainer(new ICProject[] {
                                        cproject}, ConfigBasedPathEntryContainer.CONTAINER_PATH, new NullProgressMonitor());
                            }
