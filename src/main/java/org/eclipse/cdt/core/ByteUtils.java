...
public class ByteUtils
{
     ...
     */
    public static short makeShort(byte[] bytes, int offset, boolean isle)
            throws IOException
    {
     ...
     *             if an insufficient number of bytes are supplied
     */
    public static long makeInt(byte[] bytes, int offset, boolean isle)
            throws IOException
    {
     ...
     *             if an insufficient number of bytes are supplied
     */
    public static long makeLong(byte[] bytes, int offset, boolean isle)
            throws IOException
    {
        long result = 0;
        int shift = 0;
